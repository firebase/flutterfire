...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- | ------- | --- | --- | ----- | ------- |
| AI Logic               | [![Firebase AI Logic pub.dev badge](https://img.shields.io/pub/v/firebase_ai.svg)](https://pub.dev/packages/firebase_ai)                      | [🔗](https://firebase.google.com/products/firebase-ai-logic)                 | [📖](https://firebase.google.com/docs/ai-logic/get-started)        | [`firebase_ai`](https://github.com/firebase/flutterfire/tree/main/packages/firebase_ai)                 | ✔       | ✔   | ✔   | N/A     | N/A     |

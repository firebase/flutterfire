...
8. Run `melos bom [optionnal-version]` to update the `VERSIONS.md` and `scripts/versions.json` files.
...
5. Run `melos bom [optionnal-version]` to update the `VERSIONS.md` and `scripts/versions.json` files.

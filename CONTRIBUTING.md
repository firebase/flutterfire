...
8. Run `dart scripts/generate_bom.dart` to update the `VERSIONS.md` and `scripts/versions.json` files.
...
5. Run `dart scripts/generate_bom.dart` to update the `VERSIONS.md` and `scripts/versions.json` files.

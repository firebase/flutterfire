...
data class CustomAppCheckToken (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return GeneratedAndroidFirebaseAppCheckPigeonUtils.deepEquals(this.token, other.token) && GeneratedAndroidFirebaseAppCheckPigeonUtils.deepEquals(this.expireTimeMillis, other.expireTimeMillis)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + GeneratedAndroidFirebaseAppCheckPigeonUtils.deepHash(this.token)
    result = 31 * result + GeneratedAndroidFirebaseAppCheckPigeonUtils.deepHash(this.expireTimeMillis)
    return result
  }
}

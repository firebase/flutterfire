...
void main() {
  ...
  group('$FirebaseAuth', () {
    ...
    testWidgets('signInAnonymously', (_) async {
    ...
    testWidgets('email auth', (_) async {
    ...
    testWidgets('isSignInWithEmailLink', (_) async {
    ...
    testWidgets('fetchSignInMethodsForEmail nonexistent user', (_) async {
      final String testEmail = 'testuser${Uuid().v4()}@example.com';
      final List<String> methods =
          await auth.fetchSignInMethodsForEmail(email: testEmail);

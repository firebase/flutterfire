...
public class GeneratedAndroidFirebaseAuth {
  ...
  public interface FirebaseAuthHostApi {
    ...
    void useEmulator(@NonNull AuthPigeonFirebaseApp app, @NonNull String host, @NonNull Long port, @NonNull Result<Void> result);

    void applyActionCode(@NonNull AuthPigeonFirebaseApp app, @NonNull String code, @NonNull Result<Void> result);

    void checkActionCode(@NonNull AuthPigeonFirebaseApp app, @NonNull String code, @NonNull Result<PigeonActionCodeInfo> result);

    void confirmPasswordReset(@NonNull AuthPigeonFirebaseApp app, @NonNull String code, @NonNull String newPassword, @NonNull Result<Void> result);
    ...
    void sendPasswordResetEmail(@NonNull AuthPigeonFirebaseApp app, @NonNull String email, @Nullable PigeonActionCodeSettings actionCodeSettings, @NonNull Result<Void> result);

    void sendSignInLinkToEmail(@NonNull AuthPigeonFirebaseApp app, @NonNull String email, @NonNull PigeonActionCodeSettings actionCodeSettings, @NonNull Result<Void> result);

    void setLanguageCode(@NonNull AuthPigeonFirebaseApp app, @Nullable String languageCode, @NonNull Result<String> result);

    void setSettings(@NonNull AuthPigeonFirebaseApp app, @NonNull PigeonFirebaseAuthSettings settings, @NonNull Result<Void> result);
    ...
    void revokeTokenWithAuthorizationCode(@NonNull AuthPigeonFirebaseApp app, @NonNull String authorizationCode, @NonNull Result<Void> result);
  ...
  public interface FirebaseAuthUserHostApi {
    ...
    void sendEmailVerification(@NonNull AuthPigeonFirebaseApp app, @Nullable PigeonActionCodeSettings actionCodeSettings, @NonNull Result<Void> result);
    ...
    void verifyBeforeUpdateEmail(@NonNull AuthPigeonFirebaseApp app, @NonNull String newEmail, @Nullable PigeonActionCodeSettings actionCodeSettings, @NonNull Result<Void> result);
  ...
  public interface MultiFactorUserHostApi {
    ...
    void enrollPhone(@NonNull AuthPigeonFirebaseApp app, @NonNull PigeonPhoneMultiFactorAssertion assertion, @Nullable String displayName, @NonNull Result<Void> result);

    void enrollTotp(@NonNull AuthPigeonFirebaseApp app, @NonNull String assertionId, @Nullable String displayName, @NonNull Result<Void> result);

    void getSession(@NonNull AuthPigeonFirebaseApp app, @NonNull Result<PigeonMultiFactorSession> result);

    void unenroll(@NonNull AuthPigeonFirebaseApp app, @NonNull String factorUid, @NonNull Result<Void> result);

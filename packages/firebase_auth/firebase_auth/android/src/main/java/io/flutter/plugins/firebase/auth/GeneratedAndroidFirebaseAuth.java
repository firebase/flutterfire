...
public class GeneratedAndroidFirebaseAuth {
  ...
  public static final class PigeonTotpSecret {
    ...
    private @NonNull Double enrollmentCompletionDeadline;

    public @NonNull Double getEnrollmentCompletionDeadline() {
      return enrollmentCompletionDeadline;
    }

    public void setEnrollmentCompletionDeadline(@NonNull Double setterArg) {
      if (setterArg == null) {
    ...
    public static final class Builder {
      ...
      private @Nullable Double enrollmentCompletionDeadline;

      public @NonNull Builder setEnrollmentCompletionDeadline(@NonNull Double setterArg) {
        this.enrollmentCompletionDeadline = setterArg;
        return this;
      }
    ...
    static @NonNull PigeonTotpSecret fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setEnrollmentCompletionDeadline((Double) enrollmentCompletionDeadline);
  ...
  public interface MultiFactoResolverHostApi {
    ...
    void resolveSignIn(@NonNull String resolverId, @NonNull PigeonPhoneMultiFactorAssertion assertion, @NonNull Result<PigeonUserCredential> result);
  ...
  public interface MultiFactorTotpHostApi {
    ...
    void generateSecret(@NonNull PigeonMultiFactorSession session, @NonNull Result<PigeonTotpSecret> result);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                PigeonMultiFactorSession sessionArg = (PigeonMultiFactorSession) args.get(0);
                ...
                api.generateSecret(sessionArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }

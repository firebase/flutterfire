...
- (void)useEmulatorApp:(AuthPigeonFirebaseApp *)app host:(NSString *)host port:(NSNumber *)port completion:(void (^)(FlutterError *_Nullable))completion;
...
- (void)getIdTokenApp:(AuthPigeonFirebaseApp *)app forceRefresh:(NSNumber *)forceRefresh completion:(void (^)(PigeonIdTokenResult *_Nullable, FlutterError *_Nullable))completion;

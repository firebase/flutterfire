...
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithCodeIntervalSeconds:(NSNumber *)codeIntervalSeconds
    codeLength:(NSNumber *)codeLength
    enrollmentCompletionDeadline:(NSNumber *)enrollmentCompletionDeadline
    hashingAlgorithm:(NSString *)hashingAlgorithm
    secretKey:(NSString *)secretKey;
@property(nonatomic, strong) NSNumber * codeIntervalSeconds;
@property(nonatomic, strong) NSNumber * codeLength;
@property(nonatomic, strong) NSNumber * enrollmentCompletionDeadline;
@property(nonatomic, copy) NSString * hashingAlgorithm;
...
- (void)signInAnonymouslyApp:(PigeonFirebaseApp *)app completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)signInWithCredentialApp:(PigeonFirebaseApp *)app input:(NSDictionary<NSString *, id> *)input completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)signInWithCustomTokenApp:(PigeonFirebaseApp *)app token:(NSString *)token completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)signInWithEmailAndPasswordApp:(PigeonFirebaseApp *)app email:(NSString *)email password:(NSString *)password completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)signInWithEmailLinkApp:(PigeonFirebaseApp *)app email:(NSString *)email emailLink:(NSString *)emailLink completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)signInWithProviderApp:(PigeonFirebaseApp *)app signInProvider:(PigeonSignInProvider *)signInProvider completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)signOutApp:(PigeonFirebaseApp *)app completion:(void (^)(FlutterError *_Nullable))completion;
- (void)fetchSignInMethodsForEmailApp:(PigeonFirebaseApp *)app email:(NSString *)email completion:(void (^)(NSArray<NSString *> *_Nullable, FlutterError *_Nullable))completion;
- (void)sendPasswordResetEmailApp:(PigeonFirebaseApp *)app email:(NSString *)email actionCodeSettings:(nullable PigeonActionCodeSettings *)actionCodeSettings completion:(void (^)(FlutterError *_Nullable))completion;
- (void)sendSignInLinkToEmailApp:(PigeonFirebaseApp *)app email:(NSString *)email actionCodeSettings:(PigeonActionCodeSettings *)actionCodeSettings completion:(void (^)(FlutterError *_Nullable))completion;
- (void)setLanguageCodeApp:(PigeonFirebaseApp *)app languageCode:(nullable NSString *)languageCode completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
- (void)setSettingsApp:(PigeonFirebaseApp *)app settings:(PigeonFirebaseAuthSettings *)settings completion:(void (^)(FlutterError *_Nullable))completion;
- (void)verifyPasswordResetCodeApp:(PigeonFirebaseApp *)app code:(NSString *)code completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
- (void)verifyPhoneNumberApp:(PigeonFirebaseApp *)app request:(PigeonVerifyPhoneNumberRequest *)request completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)getIdTokenApp:(PigeonFirebaseApp *)app forceRefresh:(NSNumber *)forceRefresh completion:(void (^)(PigeonIdTokenResult *_Nullable, FlutterError *_Nullable))completion;
- (void)linkWithCredentialApp:(PigeonFirebaseApp *)app input:(NSDictionary<NSString *, id> *)input completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)linkWithProviderApp:(PigeonFirebaseApp *)app signInProvider:(PigeonSignInProvider *)signInProvider completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)reauthenticateWithCredentialApp:(PigeonFirebaseApp *)app input:(NSDictionary<NSString *, id> *)input completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)reauthenticateWithProviderApp:(PigeonFirebaseApp *)app signInProvider:(PigeonSignInProvider *)signInProvider completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)reloadApp:(PigeonFirebaseApp *)app completion:(void (^)(PigeonUserDetails *_Nullable, FlutterError *_Nullable))completion;
- (void)sendEmailVerificationApp:(PigeonFirebaseApp *)app actionCodeSettings:(nullable PigeonActionCodeSettings *)actionCodeSettings completion:(void (^)(FlutterError *_Nullable))completion;
- (void)unlinkApp:(PigeonFirebaseApp *)app providerId:(NSString *)providerId completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
- (void)updateEmailApp:(PigeonFirebaseApp *)app newEmail:(NSString *)newEmail completion:(void (^)(PigeonUserDetails *_Nullable, FlutterError *_Nullable))completion;
- (void)updatePasswordApp:(PigeonFirebaseApp *)app newPassword:(NSString *)newPassword completion:(void (^)(PigeonUserDetails *_Nullable, FlutterError *_Nullable))completion;
- (void)updatePhoneNumberApp:(PigeonFirebaseApp *)app input:(NSDictionary<NSString *, id> *)input completion:(void (^)(PigeonUserDetails *_Nullable, FlutterError *_Nullable))completion;
- (void)updateProfileApp:(PigeonFirebaseApp *)app profile:(PigeonUserProfile *)profile completion:(void (^)(PigeonUserDetails *_Nullable, FlutterError *_Nullable))completion;
- (void)verifyBeforeUpdateEmailApp:(PigeonFirebaseApp *)app newEmail:(NSString *)newEmail actionCodeSettings:(nullable PigeonActionCodeSettings *)actionCodeSettings completion:(void (^)(FlutterError *_Nullable))completion;
@end

extern void FirebaseAuthUserHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FirebaseAuthUserHostApi> *_Nullable api);
...
- (void)enrollPhoneApp:(PigeonFirebaseApp *)app assertion:(PigeonPhoneMultiFactorAssertion *)assertion displayName:(nullable NSString *)displayName completion:(void (^)(FlutterError *_Nullable))completion;
- (void)getSessionApp:(PigeonFirebaseApp *)app completion:(void (^)(PigeonMultiFactorSession *_Nullable, FlutterError *_Nullable))completion;
- (void)unenrollApp:(PigeonFirebaseApp *)app factorUid:(NSString *)factorUid completion:(void (^)(FlutterError *_Nullable))completion;
- (void)getEnrolledFactorsApp:(PigeonFirebaseApp *)app completion:(void (^)(NSArray<PigeonMultiFactorInfo *> *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)resolveSignInResolverId:(NSString *)resolverId assertion:(PigeonPhoneMultiFactorAssertion *)assertion completion:(void (^)(PigeonUserCredential *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)generateSecretSession:(PigeonMultiFactorSession *)session completion:(void (^)(PigeonTotpSecret *_Nullable, FlutterError *_Nullable))completion;
@end

extern void MultiFactorTotpHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<MultiFactorTotpHostApi> *_Nullable api);

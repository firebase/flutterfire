...
> Note: This release has breaking changes.
 ...
 - **REFACTOR**: remove Firebase app initialization.
 - **REFACTOR**: Migrate firebase auth to nnbd (#4633).
 - **REFACTOR**: use core FIRApp getter utility.
 ...
 - **FIX**: suppress warnings (#3204).
 - **FIX**: unknown error codes (#3217).
 - **FIX**: add missing auth deprecations (#3257).
 ...
 - **FEAT**: allow iOS/macOS to be imported as a module.
 - **FEAT**: use new Android Firebase SDK versioning setup.
 - **FEAT**: use new iOS Firebase SDK versioning setup.
 - **FEAT**: v1 rework (#3140).
 - **FEAT**: bump android `com.android.tools.build` & `'com.google.gms:google-services` versions (#4269).
 - **FEAT**: use new MacOS Firebase SDK versioning setup.
 ...
 - **DOCS**: add missing import statement for google sign-in (#2946).
 - **DOCS**: fix readme typos (#2962).
 - **DOCS**: replace outdated pub URLs (#3146).
 ...
 - **CHORE**: Remove dependency_override in firebase_auth (#4763).
 - **CHORE**: publish packages.
 - **CHORE**: firebase_auth v0.18.0+1.
 - **CHORE**: publish packages.
 ...
 - **CHORE**: publish packages.
 - **CHORE**: update e2e version & add CI scripts (#3047).
 - **CHORE**: remove unecessary override.
 ...
 - **CHORE**: Re-enable dependency_overrides in firebase_auth (#4764).
 - **CHORE**: change calls to `initializeApp`.

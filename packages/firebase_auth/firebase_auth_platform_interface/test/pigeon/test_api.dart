...
abstract class TestMultiFactoResolverHostApi {
  ...
  Future<PigeonTotpSecret> generateSecret(PigeonMultiFactorSession session);
      ...
      {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final PigeonMultiFactorSession? arg_session =
              (args[0] as PigeonMultiFactorSession?);
          assert(arg_session != null,
              'Argument for dev.flutter.pigeon.firebase_auth_platform_interface.MultiFactorTotpHostApi.generateSecret was null, expected non-null PigeonMultiFactorSession.');
          final PigeonTotpSecret output =
              await api.generateSecret(arg_session!);
          return <Object?>[output];
        });
      }
    }

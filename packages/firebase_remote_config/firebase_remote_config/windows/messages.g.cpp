...
void RemoteConfigPigeonSettings::set_minimum_fetch_interval_seconds(int64_t value_arg) {
...
RemoteConfigPigeonSettings RemoteConfigPigeonSettings::FromEncodableList(const EncodableList& list) {
  RemoteConfigPigeonSettings decoded(
...
EncodableValue PigeonInternalCodecSerializer::ReadValueOfType(
  ...
  switch (type) {
    case 129: {
        return CustomEncodableValue(RemoteConfigPigeonSettings::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
      }
    default:
...
void PigeonInternalCodecSerializer::WriteValue(
  ...
  if (const CustomEncodableValue* custom_value = std::get_if<CustomEncodableValue>(&value)) {
    if (custom_value->type() == typeid(RemoteConfigPigeonSettings)) {
      ...
      WriteValue(EncodableValue(std::any_cast<RemoteConfigPigeonSettings>(*custom_value).ToEncodableList()), stream);
      return;
    }
  }
...
void FirebaseRemoteConfigHostApi::SetUp(
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.fetch" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.fetchAndActivate" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.activate" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.setConfigSettings" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& settings_arg = std::any_cast<const RemoteConfigPigeonSettings&>(std::get<CustomEncodableValue>(encodable_settings_arg));
          api->SetConfigSettings(app_name_arg, settings_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.setDefaults" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.ensureInitialized" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.setCustomSignals" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& custom_signals_arg = std::get<EncodableMap>(encodable_custom_signals_arg);
          api->SetCustomSignals(app_name_arg, custom_signals_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.getAll" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_name_arg = std::get<std::string>(encodable_app_name_arg);
          api->GetAll(app_name_arg, [reply](ErrorOr<EncodableMap>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.firebase_remote_config_platform_interface.FirebaseRemoteConfigHostApi.getProperties" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_name_arg = std::get<std::string>(encodable_app_name_arg);
          api->GetProperties(app_name_arg, [reply](ErrorOr<EncodableMap>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }

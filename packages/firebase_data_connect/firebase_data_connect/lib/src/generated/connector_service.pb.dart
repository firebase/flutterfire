...
class ExecuteQueryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecuteQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firebase.dataconnect.v1alpha'), createEmptyInstance: create)
...
class ExecuteMutationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecuteMutationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firebase.dataconnect.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'operationName')
    ..aOM<$1.Struct>(3, _omitFieldNames ? '' : 'variables', subBuilder: $1.Struct.create)
    ..hasRequiredFields = false
...
class ExecuteQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecuteQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firebase.dataconnect.v1alpha'), createEmptyInstance: create)
    ..aOM<$1.Struct>(1, _omitFieldNames ? '' : 'data', subBuilder: $1.Struct.create)
    ..pc<$2.GraphqlError>(2, _omitFieldNames ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: $2.GraphqlError.create)
    ..hasRequiredFields = false
  ;
...
class ExecuteMutationResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecuteMutationResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firebase.dataconnect.v1alpha'), createEmptyInstance: create)
    ..aOM<$1.Struct>(1, _omitFieldNames ? '' : 'data', subBuilder: $1.Struct.create)
    ..pc<$2.GraphqlError>(2, _omitFieldNames ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: $2.GraphqlError.create)
    ..hasRequiredFields = false
  ;

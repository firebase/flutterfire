...
class ListMoviesMovies {
  ...
  id = nativeFromJson<String>(json['id']),title = nativeFromJson<String>(json['title']),directed_by = (json['directed_by'] as List<dynamic>)
        .map((e) => ListMoviesMoviesDirectedBy.fromJson(e))
        .toList(),rating = json['rating'] == null ? null : nativeFromJson<double>(json['rating']);

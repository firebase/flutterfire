...
class ListMoviesByPartialTitle {
  ...
  Deserializer<ListMoviesByPartialTitleResponse> dataDeserializer = (String json)  => ListMoviesByPartialTitleResponse.fromJson(jsonDecode(json) as Map<String, dynamic>);
  ...
  QueryRef<ListMoviesByPartialTitleResponse, ListMoviesByPartialTitleVariables> ref(

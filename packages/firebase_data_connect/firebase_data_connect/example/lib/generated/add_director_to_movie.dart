...
class AddDirectorToMovie {
  ...
  MutationRef<AddDirectorToMovieResponse, AddDirectorToMovieVariables> ref(
      {AddDirectorToMovieVariablesPersonId? personId,String? movieId,AddDirectorToMovieVariables?addDirectorToMovieVariables}) {
    AddDirectorToMovieVariables vars1=AddDirectorToMovieVariables(personId: personId,movieId: movieId,);

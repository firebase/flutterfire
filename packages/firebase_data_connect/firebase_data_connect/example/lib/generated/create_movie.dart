...
class CreateMovieVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  CreateMovieVariablesBuilder rating(double? t) {
   _rating.value = t;
   return this;
  }
  ...
  CreateMovieVariablesBuilder(this._dataConnect, {required  this.title,required  this.releaseYear,required  this.genre,});
  ...
  MutationRef<CreateMovieData, CreateMovieVariables> ref() {
    CreateMovieVariables vars= CreateMovieVariables(title: title,releaseYear: releaseYear,genre: genre,rating: _rating,description: _description,);
...
class CreateMovieVariables {
  ...
  title = nativeFromJson<String>(json['title']),releaseYear = nativeFromJson<int>(json['releaseYear']),genre = nativeFromJson<String>(json['genre']) {

...
class CreateMovie {
  ...
  Deserializer<CreateMovieResponse> dataDeserializer = (String json)  => CreateMovieResponse.fromJson(jsonDecode(json) as Map<String, dynamic>);
  Serializer<CreateMovieVariables> varsSerializer = jsonEncode;
  MutationRef<CreateMovieResponse, CreateMovieVariables> ref(
      {required String title,required int releaseYear,required String genre,double? rating,String? description,CreateMovieVariables?createMovieVariables}) {
    CreateMovieVariables vars1=CreateMovieVariables(title: title,releaseYear: releaseYear,genre: genre,rating: rating,description: description,);

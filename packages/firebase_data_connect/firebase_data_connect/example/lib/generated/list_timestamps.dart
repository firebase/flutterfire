...
class ListTimestampsVariablesBuilder {
  ...
  Deserializer<ListTimestampsData> dataDeserializer = (dynamic json)  => ListTimestampsData.fromJson(jsonDecode(json));
  ...
  QueryRef<ListTimestampsData, void> ref() {
    ...
    return _dataConnect.query("ListTimestamps", dataDeserializer, emptySerializer, null);
  }
}
...
class ListTimestampsTimestampHolders {
  ...
  timestamp = Timestamp.fromJson(json['timestamp']),date = json['date'] == null ? null : nativeFromJson<DateTime>(json['date']);

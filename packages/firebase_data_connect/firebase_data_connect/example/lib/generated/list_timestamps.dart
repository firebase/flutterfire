...
class ListTimestamps {
  ...
  Deserializer<ListTimestampsData> dataDeserializer = (String json)  => ListTimestampsData.fromJson(jsonDecode(json) as Map<String, dynamic>);
...
class ListTimestampsData {
   ...
   List<ListTimestampsTimestampHolders> timestampHolders;
    ...
    ListTimestampsData.fromJson(Map<String, dynamic> json):
      ...
      (json['timestampHolders'] as List<dynamic>)
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {};
      ...
      json['timestampHolders'] = 
  
    
      timestampHolders.map((e) => e.toJson()).toList()

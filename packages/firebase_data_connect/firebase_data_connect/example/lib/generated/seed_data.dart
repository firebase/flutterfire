...
class SeedDataVariablesBuilder {
  ...
  SeedDataVariablesBuilder(this.dataConnect, );
  Deserializer<SeedDataData> dataDeserializer = (String json)  => SeedDataData.fromJson(jsonDecode(json) as Map<String, dynamic>);
  
  MutationRef<SeedDataData, void> build() {
    
    return dataConnect.mutation("seedData", dataDeserializer, emptySerializer, null);
  }
}
class SeedData {
...
class SeedDataData {
   ...
   SeedDataTheMatrix the_matrix;
    ...
    SeedDataTheMatrix.fromJson(json['the_matrix'])

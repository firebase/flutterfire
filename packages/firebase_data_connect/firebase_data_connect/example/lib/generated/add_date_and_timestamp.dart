...
class AddDateAndTimestamp {
  ...
  Deserializer<AddDateAndTimestampData> dataDeserializer = (String json)  => AddDateAndTimestampData.fromJson(jsonDecode(json) as Map<String, dynamic>);
  ...
  MutationRef<AddDateAndTimestampData, AddDateAndTimestampVariables> ref(
      {required DateTime date = ,required Timestamp timestamp,}) {
...
class AddDateAndTimestampData {
   ...
   AddDateAndTimestampTimestampHolderInsert timestampHolder_insert;
    ...
    AddDateAndTimestampTimestampHolderInsert.fromJson(json['timestampHolder_insert'])

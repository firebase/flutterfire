...
class ListThingVariablesBuilder {
  ...
  ListThingVariablesBuilder(this.dataConnect, {AnyValue? this.data,});
  Deserializer<ListThingData> dataDeserializer = (String json)  => ListThingData.fromJson(jsonDecode(json) as Map<String, dynamic>);
  Serializer<ListThingVariables> varsSerializer = (ListThingVariables vars) => jsonEncode(vars.toJson());
  QueryRef<ListThingData, ListThingVariables> build() {
    ListThingVariables vars=ListThingVariables(data: data,);

    return dataConnect.query("ListThing", dataDeserializer, varsSerializer, vars);
  }
}
class ListThing {

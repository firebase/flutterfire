      ...
      {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.getReferencebyPath was null, expected non-null PigeonStorageFirebaseApp.');
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.setMaxOperationRetryTime was null, expected non-null PigeonStorageFirebaseApp.');
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.setMaxUploadRetryTime was null, expected non-null PigeonStorageFirebaseApp.');
          final int? arg_time = (args[1] as int?);
          assert(arg_time != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.setMaxDownloadRetryTime was null, expected non-null PigeonStorageFirebaseApp.');
          final int? arg_time = (args[1] as int?);
          assert(arg_time != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.useStorageEmulator was null, expected non-null PigeonStorageFirebaseApp.');
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceDelete was null, expected non-null PigeonStorageFirebaseApp.');
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceGetDownloadURL was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceGetMetaData was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceList was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceListAll was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceGetData was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referencePutData was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referencePutString was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referencePutFile was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceDownloadFile was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.referenceUpdateMetadata was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference =
              (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.taskPause was null, expected non-null PigeonStorageFirebaseApp.');
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.taskResume was null, expected non-null PigeonStorageFirebaseApp.');
          final int? arg_handle = (args[1] as int?);
          assert(arg_handle != null,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final PigeonStorageFirebaseApp? arg_app =
              (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.FirebaseStorageHostApi.taskCancel was null, expected non-null PigeonStorageFirebaseApp.');
          final int? arg_handle = (args[1] as int?);
          assert(arg_handle != null,

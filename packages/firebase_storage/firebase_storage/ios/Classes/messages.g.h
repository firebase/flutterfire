...
/// Wrapper for PigeonTaskState to allow for nullability.
@interface PigeonTaskStateBox : NSObject
@property(nonatomic, assign) PigeonTaskState value;
- (instancetype)initWithValue:(PigeonTaskState)value;
@end

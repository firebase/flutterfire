...
- (void)registerStorageTaskApp:(PigeonFirebaseApp *)app bucket:(nullable NSString *)bucket completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;

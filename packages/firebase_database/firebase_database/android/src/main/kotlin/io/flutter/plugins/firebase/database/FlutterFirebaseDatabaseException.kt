...
class FlutterFirebaseDatabaseException @JvmOverloads constructor(
    ...
    companion object {
        ...
        fun fromException(e: Exception?): FlutterFirebaseDatabaseException {
            return if (e == null) unknown() else unknown(e.message ?: UNKNOWN_ERROR_MESSAGE)
        }

        fun unknown(): FlutterFirebaseDatabaseException {
            return unknown(null)
        }
    ...
    val additionalData: Map<String, Any> = additionalData?.toMutableMap()?.apply {

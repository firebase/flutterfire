...
private func doubleEqualsFirebaseDatabaseMessages(_ lhs: Double, _ rhs: Double) -> Bool {
  (lhs.isNaN && rhs.isNaN) || lhs == rhs
}

private func doubleHashFirebaseDatabaseMessages(_ value: Double, _ hasher: inout Hasher) {
  if value.isNaN {
...
func deepEqualsFirebaseDatabaseMessages(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case let (lhsArray, rhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in lhsArray.enumerated() {
      if !deepEqualsFirebaseDatabaseMessages(element, rhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case let (lhsArray, rhsArray) as ([Double], [Double]):
    guard lhsArray.count == rhsArray.count else { return false }
    for (index, element) in lhsArray.enumerated() {
      if !doubleEqualsFirebaseDatabaseMessages(element, rhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case let (lhsDictionary, rhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (lhsKey, lhsValue) in lhsDictionary {
      ...
      for (rhsKey, rhsValue) in rhsDictionary {
        if deepEqualsFirebaseDatabaseMessages(lhsKey, rhsKey) {
          if deepEqualsFirebaseDatabaseMessages(lhsValue, rhsValue) {
            found = true
            break
          } else {
            return false
  ...
  case (let lhs as Double, let rhs as Double):
    return doubleEqualsFirebaseDatabaseMessages(lhs, rhs)
...
func deepHashFirebaseDatabaseMessages(value: Any?, hasher: inout Hasher) {
  ...
  if let cleanValue {
    if let doubleValue = cleanValue as? Double {
      doubleHashFirebaseDatabaseMessages(doubleValue, &hasher)
      ...
      for item in valueList {
        doubleHashFirebaseDatabaseMessages(item, &hasher)
      }
    } else if let valueDict = cleanValue as? [AnyHashable: Any?] {
      var result = 0
      for (key, value) in valueDict {
        var entryKeyHasher = Hasher()
        deepHashFirebaseDatabaseMessages(value: key, hasher: &entryKeyHasher)
        var entryValueHasher = Hasher()
        deepHashFirebaseDatabaseMessages(value: value, hasher: &entryValueHasher)
...
struct DatabasePigeonSettings: Hashable {
  ...
  static func == (lhs: DatabasePigeonSettings, rhs: DatabasePigeonSettings) -> Bool {
    ...
    return deepEqualsFirebaseDatabaseMessages(lhs.persistenceEnabled, rhs.persistenceEnabled)
      && deepEqualsFirebaseDatabaseMessages(
        lhs.cacheSizeBytes,
        rhs.cacheSizeBytes
      ) && deepEqualsFirebaseDatabaseMessages(lhs.loggingEnabled, rhs.loggingEnabled)
      && deepEqualsFirebaseDatabaseMessages(
        lhs.emulatorHost,
        rhs.emulatorHost
      ) && deepEqualsFirebaseDatabaseMessages(lhs.emulatorPort, rhs.emulatorPort)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("DatabasePigeonSettings")
    deepHashFirebaseDatabaseMessages(value: persistenceEnabled, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: cacheSizeBytes, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: loggingEnabled, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: emulatorHost, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: emulatorPort, hasher: &hasher)
  }
}
...
struct DatabasePigeonFirebaseApp: Hashable {
  ...
  static func == (lhs: DatabasePigeonFirebaseApp, rhs: DatabasePigeonFirebaseApp) -> Bool {
    ...
    return deepEqualsFirebaseDatabaseMessages(lhs.appName, rhs.appName)
      && deepEqualsFirebaseDatabaseMessages(
        lhs.databaseURL,
        rhs.databaseURL
      ) && deepEqualsFirebaseDatabaseMessages(lhs.settings, rhs.settings)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("DatabasePigeonFirebaseApp")
    deepHashFirebaseDatabaseMessages(value: appName, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: databaseURL, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: settings, hasher: &hasher)
  }
}
...
struct DatabaseReferencePlatform: Hashable {
  ...
  static func == (lhs: DatabaseReferencePlatform, rhs: DatabaseReferencePlatform) -> Bool {
    ...
    return deepEqualsFirebaseDatabaseMessages(lhs.path, rhs.path)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("DatabaseReferencePlatform")
    deepHashFirebaseDatabaseMessages(value: path, hasher: &hasher)
  }
}
  ...
  static func == (lhs: DatabaseReferenceRequest, rhs: DatabaseReferenceRequest) -> Bool {
    ...
    return deepEqualsFirebaseDatabaseMessages(lhs.path, rhs.path)
      && deepEqualsFirebaseDatabaseMessages(
        lhs.value,
        rhs.value
      ) && deepEqualsFirebaseDatabaseMessages(lhs.priority, rhs.priority)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("DatabaseReferenceRequest")
    deepHashFirebaseDatabaseMessages(value: path, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: value, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: priority, hasher: &hasher)
  }
}
  ...
  static func == (lhs: TransactionRequest, rhs: TransactionRequest) -> Bool {
    ...
    return deepEqualsFirebaseDatabaseMessages(lhs.path, rhs.path)
      && deepEqualsFirebaseDatabaseMessages(
        lhs.transactionKey,
        rhs.transactionKey
      ) && deepEqualsFirebaseDatabaseMessages(lhs.applyLocally, rhs.applyLocally)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("TransactionRequest")
    deepHashFirebaseDatabaseMessages(value: path, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: transactionKey, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: applyLocally, hasher: &hasher)
  }
}
  ...
  static func == (lhs: QueryRequest, rhs: QueryRequest) -> Bool {
    ...
    return deepEqualsFirebaseDatabaseMessages(lhs.path, rhs.path)
      && deepEqualsFirebaseDatabaseMessages(
        lhs.modifiers,
        rhs.modifiers
      ) && deepEqualsFirebaseDatabaseMessages(lhs.value, rhs.value)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("QueryRequest")
    deepHashFirebaseDatabaseMessages(value: path, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: modifiers, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: value, hasher: &hasher)
  }
}
...
struct TransactionHandlerResult: Hashable {
  ...
  static func == (lhs: TransactionHandlerResult, rhs: TransactionHandlerResult) -> Bool {
    ...
    return deepEqualsFirebaseDatabaseMessages(lhs.value, rhs.value)
      && deepEqualsFirebaseDatabaseMessages(
        lhs.aborted,
        rhs.aborted
      ) && deepEqualsFirebaseDatabaseMessages(lhs.exception, rhs.exception)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("TransactionHandlerResult")
    deepHashFirebaseDatabaseMessages(value: value, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: aborted, hasher: &hasher)
    deepHashFirebaseDatabaseMessages(value: exception, hasher: &hasher)
  }
}
...
class FirebaseDatabaseHostApiSetup {
  ...
  /// `binaryMessenger`.
  static func setUp(
    binaryMessenger: FlutterBinaryMessenger, api: FirebaseDatabaseHostApi?,
      ...
      databaseReferenceGetTransactionResultChannel.setMessageHandler { message, reply in
        ...
        api
          .databaseReferenceGetTransactionResult(
            app: appArg,
            transactionKey: transactionKeyArg
          ) { result in
            switch result {
            case .success(let res):
              reply(wrapResult(res))
...
protocol FirebaseDatabaseFlutterApiProtocol {
  func callTransactionHandler(
    transactionKey transactionKeyArg: Int64,
    snapshotValue snapshotValueArg: Any?,
    completion:
      @escaping (Result<TransactionHandlerResult, PigeonError>)
      -> Void)
}

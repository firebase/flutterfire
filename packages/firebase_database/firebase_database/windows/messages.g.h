...
class DatabasePigeonSettings {
 public:
  ...
  bool operator==(const DatabasePigeonSettings& other) const;
  bool operator!=(const DatabasePigeonSettings& other) const;
...
class DatabasePigeonFirebaseApp {
 public:
  ...
  bool operator==(const DatabasePigeonFirebaseApp& other) const;
  bool operator!=(const DatabasePigeonFirebaseApp& other) const;
  /// Returns a hash code value for the object. This method is supported for the
  /// benefit of hash tables.
  size_t Hash() const;
...
class DatabaseReferencePlatform {
 public:
  ...
  bool operator==(const DatabaseReferencePlatform& other) const;
  bool operator!=(const DatabaseReferencePlatform& other) const;
  /// Returns a hash code value for the object. This method is supported for the
  /// benefit of hash tables.
  size_t Hash() const;
...
class DatabaseReferenceRequest {
 public:
  ...
  bool operator==(const DatabaseReferenceRequest& other) const;
  bool operator!=(const DatabaseReferenceRequest& other) const;
  /// Returns a hash code value for the object. This method is supported for the
  /// benefit of hash tables.
  size_t Hash() const;
...
class TransactionRequest {
 public:
  ...
  bool operator==(const TransactionRequest& other) const;
  bool operator!=(const TransactionRequest& other) const;
  /// Returns a hash code value for the object. This method is supported for the
  /// benefit of hash tables.
  size_t Hash() const;
...
class TransactionHandlerResult {
 public:
  ...
  bool operator==(const TransactionHandlerResult& other) const;
  bool operator!=(const TransactionHandlerResult& other) const;
  /// Returns a hash code value for the object. This method is supported for the
  /// benefit of hash tables.
  size_t Hash() const;

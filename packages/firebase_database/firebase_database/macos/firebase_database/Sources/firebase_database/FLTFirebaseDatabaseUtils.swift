...
@objc class FLTFirebaseDatabaseUtils: NSObject {
    ...
    static func dispatchQueue() -> DispatchQueue {
        struct Static {
            static let sharedInstance = DispatchQueue(label: "io.flutter.plugins.firebase.database", qos: .userInitiated)
        }
    ...
    private static func databaseQuery(_ query: DatabaseQuery, applyLimitModifier modifier: [String: Any]) -> DatabaseQuery {
    ...
    private static func databaseQuery(_ query: DatabaseQuery, applyOrderModifier modifier: [String: Any]) -> DatabaseQuery {
        let name = modifier["name"] as? String ?? ""
    ...
    private static func databaseQuery(_ query: DatabaseQuery, applyCursorModifier modifier: [String: Any]) -> DatabaseQuery {
        let name = modifier["name"] as? String ?? ""
    ...
    static func dictionary(from snapshot: DataSnapshot, withPreviousChildKey previousChildKey: String?) -> [String: Any] {
        return [

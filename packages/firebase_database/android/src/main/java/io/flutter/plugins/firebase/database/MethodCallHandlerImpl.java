    ...
    public void onMethodCall(final MethodCall call, @NonNull final MethodChannel.Result result) {
        ...
        switch (call.method) {
            ...
            case "DatabaseReference#set":
            {
                ...
                if (priority != null) {
                    reference.setValue(value, priority, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                } else {
            ...
            case "DatabaseReference#update":
            {
                ...
                DatabaseReference reference = getReference(database, arguments);
                reference.updateChildren(value, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                break;
            }
            ...
            case "DatabaseReference#setPriority":
            {
                Object priority = call.argument("priority");
                DatabaseReference reference = getReference(database, arguments);
                reference.setPriority(priority, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                break;
            }
            ...
            case "OnDisconnect#set":
            {
                ...
                if (priority != null) {
                    if (priority instanceof String) {
                        reference
                                .onDisconnect()
                                .setValue(value, (String) priority, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                    } else if (priority instanceof Double) {
                        reference
                                .onDisconnect()
                                .setValue(value, (double) priority, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                    } else if (priority instanceof Map) {
                        reference
                                .onDisconnect()
                                .setValue(value, (Map) priority, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                    }
                } else {
                    reference.onDisconnect().setValue(value, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                }
                break;
            }
            ...
            case "OnDisconnect#update":
            {
                Map<String, Object> value = call.argument("value");
                DatabaseReference reference = getReference(database, arguments);
                reference.onDisconnect().updateChildren(value, new MethodCallHandlerImpl.DefaultCompletionListener(result));
                break;
            }
            ...
            {
                DatabaseReference reference = getReference(database, arguments);
                reference.onDisconnect().cancel(new MethodCallHandlerImpl.DefaultCompletionListener(result));
                break;
            }
            ...
            case "Query#observe":
            {
                ...
                MethodCallHandlerImpl.EventObserver observer = new MethodCallHandlerImpl.EventObserver(eventType, handle);

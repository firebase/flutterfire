...
/// Collection of FLTAd subclass instances.
@interface FLTAdCollection : NSObject
/// Adds `ad` to the collection for `referenceId`.
- (void)addAd:(id<FLTAd> _Nonnull)ad forReferenceId:(NSNumber *_Nonnull)referenceId;
...
- (id<FLTAd> _Nullable)adForReferenceId:(NSNumber *_Nonnull)referenceId;

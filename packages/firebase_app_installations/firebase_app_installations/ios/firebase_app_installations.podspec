...
Pod::Spec.new do |s|
  ...
  s.source           = { :path => '.' }
  s.source_files     = 'firebase_app_installations/Sources/firebase_app_installations/**/*'
  s.public_header_files = 'firebase_app_installations/Sources/firebase_app_installations/include/*.h'

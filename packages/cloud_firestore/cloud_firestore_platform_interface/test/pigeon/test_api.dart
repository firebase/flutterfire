...
abstract class TestFirebaseFirestoreHostApi {
  ...
  Future<PigeonQuerySnapshot> namedQueryGet(
      FirestorePigeonFirebaseApp app, String name, PigeonGetOptions options);
  ...
  Future<void> writeBatchCommit(
      FirestorePigeonFirebaseApp app, List<PigeonTransactionCommand?> writes);
  ...
  Future<String> documentReferenceSnapshot(FirestorePigeonFirebaseApp app,
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final double output = await api.aggregateQueryCount(arg_app!,
              arg_path!, arg_parameters!, arg_source!, arg_isCollectionGroup!);
          return <Object?>[output];
        });
      }
    }

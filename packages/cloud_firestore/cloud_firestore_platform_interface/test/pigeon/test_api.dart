...
abstract class TestFirebaseFirestoreHostApi {
  ...
  Future<PigeonQuerySnapshot> namedQueryGet(PigeonFirebaseApp app, String name, PigeonGetOptions options);
  ...
  Future<void> setIndexConfiguration(PigeonFirebaseApp app, String indexConfiguration);
  ...
  Future<PigeonDocumentSnapshot> transactionGet(PigeonFirebaseApp app, String transactionId, String path);

  Future<void> documentReferenceSet(PigeonFirebaseApp app, DocumentReferenceRequest request);

  Future<void> documentReferenceUpdate(PigeonFirebaseApp app, DocumentReferenceRequest request);

  Future<PigeonDocumentSnapshot> documentReferenceGet(PigeonFirebaseApp app, DocumentReferenceRequest request);

  Future<void> documentReferenceDelete(PigeonFirebaseApp app, DocumentReferenceRequest request);

  Future<PigeonQuerySnapshot> queryGet(PigeonFirebaseApp app, String path, bool isCollectionGroup, PigeonQueryParameters parameters, PigeonGetOptions options);

  Future<double> aggregateQueryCount(PigeonFirebaseApp app, String path, PigeonQueryParameters parameters, AggregateSource source);

  Future<void> writeBatchCommit(PigeonFirebaseApp app, List<PigeonTransactionCommand?> writes);

  Future<String> querySnapshot(PigeonFirebaseApp app, String path, bool isCollectionGroup, PigeonQueryParameters parameters, PigeonGetOptions options, bool includeMetadataChanges);

  Future<String> documentReferenceSnapshot(PigeonFirebaseApp app, DocumentReferenceRequest parameters, bool includeMetadataChanges);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          final double output = await api.aggregateQueryCount(arg_app!, arg_path!, arg_parameters!, arg_source!);
          return <Object?>[output];
        });
      }
    }
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          assert(arg_includeMetadataChanges != null,
              'Argument for dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.querySnapshot was null, expected non-null bool.');
          final String output = await api.querySnapshot(arg_app!, arg_path!, arg_isCollectionGroup!, arg_parameters!, arg_options!, arg_includeMetadataChanges!);
          return <Object?>[output];
        });
      }
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          final String output = await api.documentReferenceSnapshot(arg_app!, arg_parameters!, arg_includeMetadataChanges!);
          return <Object?>[output];
        });
      }
    }

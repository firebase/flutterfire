...
public class GeneratedAndroidFirebaseFirestore {
  ...
  public interface FirebaseFirestoreHostApi {
    ...
    void loadBundle(@NonNull PigeonFirebaseApp app, @NonNull byte[] bundle, @NonNull Result<String> result);

    void namedQueryGet(@NonNull PigeonFirebaseApp app, @NonNull String name, @NonNull PigeonGetOptions options, @NonNull Result<PigeonQuerySnapshot> result);
    ...
    void setIndexConfiguration(@NonNull PigeonFirebaseApp app, @NonNull String indexConfiguration, @NonNull Result<Void> result);
    ...
    void transactionGet(@NonNull PigeonFirebaseApp app, @NonNull String transactionId, @NonNull String path, @NonNull Result<PigeonDocumentSnapshot> result);

    void documentReferenceSet(@NonNull PigeonFirebaseApp app, @NonNull DocumentReferenceRequest request, @NonNull Result<Void> result);

    void documentReferenceUpdate(@NonNull PigeonFirebaseApp app, @NonNull DocumentReferenceRequest request, @NonNull Result<Void> result);

    void documentReferenceGet(@NonNull PigeonFirebaseApp app, @NonNull DocumentReferenceRequest request, @NonNull Result<PigeonDocumentSnapshot> result);

    void documentReferenceDelete(@NonNull PigeonFirebaseApp app, @NonNull DocumentReferenceRequest request, @NonNull Result<Void> result);

    void queryGet(@NonNull PigeonFirebaseApp app, @NonNull String path, @NonNull Boolean isCollectionGroup, @NonNull PigeonQueryParameters parameters, @NonNull PigeonGetOptions options, @NonNull Result<PigeonQuerySnapshot> result);

    void aggregateQueryCount(@NonNull PigeonFirebaseApp app, @NonNull String path, @NonNull PigeonQueryParameters parameters, @NonNull AggregateSource source, @NonNull Result<Double> result);

    void writeBatchCommit(@NonNull PigeonFirebaseApp app, @NonNull List<PigeonTransactionCommand> writes, @NonNull Result<Void> result);

    void querySnapshot(@NonNull PigeonFirebaseApp app, @NonNull String path, @NonNull Boolean isCollectionGroup, @NonNull PigeonQueryParameters parameters, @NonNull PigeonGetOptions options, @NonNull Boolean includeMetadataChanges, @NonNull Result<String> result);

    void documentReferenceSnapshot(@NonNull PigeonFirebaseApp app, @NonNull DocumentReferenceRequest parameters, @NonNull Boolean includeMetadataChanges, @NonNull Result<String> result);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable FirebaseFirestoreHostApi api) {
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                PigeonTransactionResult resultTypeArg = args.get(1) == null ? null : PigeonTransactionResult.values()[(int) args.get(1)];
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.aggregateQueryCount", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                AggregateSource sourceArg = args.get(3) == null ? null : AggregateSource.values()[(int) args.get(3)];

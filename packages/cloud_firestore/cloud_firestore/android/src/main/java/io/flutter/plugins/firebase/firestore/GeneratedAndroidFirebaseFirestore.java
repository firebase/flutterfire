...
public class GeneratedAndroidFirebaseFirestore {
  ...
  public interface FirebaseFirestoreHostApi {
    ...
    void querySnapshot(@NonNull FirestorePigeonFirebaseApp app, @NonNull String path, @NonNull Boolean isCollectionGroup, @NonNull PigeonQueryParameters parameters, @NonNull PigeonGetOptions options, @NonNull Boolean includeMetadataChanges, @NonNull ListenSource source, @NonNull Result<String> result);

    void documentReferenceSnapshot(@NonNull FirestorePigeonFirebaseApp app, @NonNull DocumentReferenceRequest parameters, @NonNull Boolean includeMetadataChanges, @NonNull ListenSource source, @NonNull Result<String> result);

...
FirestorePigeonFirebaseApp::FirestorePigeonFirebaseApp(
    ...
    : app_name_(app_name),
      settings_(std::make_unique<PigeonFirebaseSettings>(settings)),
      database_u_r_l_(database_u_r_l) {}

FirestorePigeonFirebaseApp::FirestorePigeonFirebaseApp(
    const FirestorePigeonFirebaseApp& other)
    : app_name_(other.app_name_),
      settings_(std::make_unique<PigeonFirebaseSettings>(*other.settings_)),
...
void FirestorePigeonFirebaseApp::set_settings(
  ...
  settings_ = std::make_unique<PigeonFirebaseSettings>(value_arg);
}
...
FirestorePigeonFirebaseApp FirestorePigeonFirebaseApp::FromEncodableList(
  ...
  FirestorePigeonFirebaseApp decoded(
      ...
      std::any_cast<const PigeonFirebaseSettings&>(
...
PigeonDocumentSnapshot::PigeonDocumentSnapshot(
    ...
    : path_(path),
      metadata_(std::make_unique<PigeonSnapshotMetadata>(metadata)) {}
...
PigeonDocumentSnapshot::PigeonDocumentSnapshot(
    const PigeonDocumentSnapshot& other)
    : path_(other.path_),
      data_(other.data_ ? std::optional<EncodableMap>(*other.data_)
                        : std::nullopt),
      metadata_(std::make_unique<PigeonSnapshotMetadata>(*other.metadata_)) {}

PigeonDocumentSnapshot& PigeonDocumentSnapshot::operator=(
    const PigeonDocumentSnapshot& other) {
  path_ = other.path_;
  data_ = other.data_;
  metadata_ = std::make_unique<PigeonSnapshotMetadata>(*other.metadata_);
...
void PigeonDocumentSnapshot::set_metadata(
  ...
  metadata_ = std::make_unique<PigeonSnapshotMetadata>(value_arg);
}
...
PigeonDocumentSnapshot PigeonDocumentSnapshot::FromEncodableList(
  ...
  PigeonDocumentSnapshot decoded(std::get<std::string>(list[0]),
                                 std::any_cast<const PigeonSnapshotMetadata&>(
...
PigeonDocumentChange::PigeonDocumentChange(
    ...
    : type_(type),
      document_(std::make_unique<PigeonDocumentSnapshot>(document)),
      old_index_(old_index),
      new_index_(new_index) {}

PigeonDocumentChange::PigeonDocumentChange(const PigeonDocumentChange& other)
    : type_(other.type_),
      document_(std::make_unique<PigeonDocumentSnapshot>(*other.document_)),
      old_index_(other.old_index_),
      new_index_(other.new_index_) {}

PigeonDocumentChange& PigeonDocumentChange::operator=(
    const PigeonDocumentChange& other) {
  type_ = other.type_;
  document_ = std::make_unique<PigeonDocumentSnapshot>(*other.document_);
  old_index_ = other.old_index_;
  new_index_ = other.new_index_;
...
void PigeonDocumentChange::set_document(
  ...
  document_ = std::make_unique<PigeonDocumentSnapshot>(value_arg);
}
...
PigeonDocumentChange PigeonDocumentChange::FromEncodableList(
    const EncodableList& list) {
  PigeonDocumentChange decoded(std::any_cast<const DocumentChangeType&>(
                                   std::get<CustomEncodableValue>(list[0])),
                               std::any_cast<const PigeonDocumentSnapshot&>(
                                   std::get<CustomEncodableValue>(list[1])),
...
PigeonQuerySnapshot::PigeonQuerySnapshot(const PigeonQuerySnapshot& other)
    : documents_(other.documents_),
      document_changes_(other.document_changes_),
      metadata_(std::make_unique<PigeonSnapshotMetadata>(*other.metadata_)) {}

PigeonQuerySnapshot& PigeonQuerySnapshot::operator=(
    const PigeonQuerySnapshot& other) {
  documents_ = other.documents_;
  document_changes_ = other.document_changes_;
  metadata_ = std::make_unique<PigeonSnapshotMetadata>(*other.metadata_);
  return *this;
...
PigeonTransactionCommand::PigeonTransactionCommand(
    ...
    : type_(type),
      path_(path),
      data_(data ? std::optional<EncodableMap>(*data) : std::nullopt),
      option_(option ? std::make_unique<PigeonDocumentOption>(*option)
                     : nullptr) {}

PigeonTransactionCommand::PigeonTransactionCommand(
    const PigeonTransactionCommand& other)
    : type_(other.type_),
      path_(other.path_),
      data_(other.data_ ? std::optional<EncodableMap>(*other.data_)
                        : std::nullopt),
      option_(other.option_
                  ? std::make_unique<PigeonDocumentOption>(*other.option_)
                  : nullptr) {}

PigeonTransactionCommand& PigeonTransactionCommand::operator=(
    const PigeonTransactionCommand& other) {
  type_ = other.type_;
  path_ = other.path_;
  data_ = other.data_;
...
void PigeonTransactionCommand::set_option(
  ...
  option_ =
      value_arg ? std::make_unique<PigeonDocumentOption>(*value_arg) : nullptr;
}

void PigeonTransactionCommand::set_option(
    const PigeonDocumentOption& value_arg) {
  option_ = std::make_unique<PigeonDocumentOption>(value_arg);
}
...
PigeonTransactionCommand PigeonTransactionCommand::FromEncodableList(
    const EncodableList& list) {
  PigeonTransactionCommand decoded(std::any_cast<const PigeonTransactionType&>(
                                       std::get<CustomEncodableValue>(list[0])),
  ...
  if (!encodable_option.IsNull()) {
    decoded.set_option(std::any_cast<const PigeonDocumentOption&>(
  ...
  switch (type) {
    ...
    case 147: {
      ...
      return encodable_enum_arg.IsNull()
                 ? EncodableValue()
                 : CustomEncodableValue(
                       static_cast<PigeonTransactionResult>(enum_arg_value));
    }
    case 148: {
      const auto& encodable_enum_arg = ReadValue(stream);
      const int64_t enum_arg_value =
      ...
      return encodable_enum_arg.IsNull()
                 ? EncodableValue()
                 : CustomEncodableValue(
                       static_cast<PigeonTransactionType>(enum_arg_value));
    }
    case 149: {
      const auto& encodable_enum_arg = ReadValue(stream);
      const int64_t enum_arg_value =
...
void PigeonCodecSerializer::WriteValue(
  ...
  if (const CustomEncodableValue* custom_value =
    ...
    if (custom_value->type() == typeid(PigeonTransactionResult)) {
      stream->WriteByte(147);
      WriteValue(EncodableValue(static_cast<int>(
                     std::any_cast<PigeonTransactionResult>(*custom_value))),
                 stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonTransactionType)) {
      stream->WriteByte(148);
      WriteValue(EncodableValue(static_cast<int>(
                     std::any_cast<PigeonTransactionType>(*custom_value))),
                 stream);
      return;
    }

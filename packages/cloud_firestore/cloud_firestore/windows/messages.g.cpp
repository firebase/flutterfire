...
PigeonFirebaseSettings::PigeonFirebaseSettings(
 ...
 : persistence_enabled_(persistence_enabled ? std::optional<bool>(*persistence_enabled) : std::nullopt),
    ...
    ssl_enabled_(ssl_enabled ? std::optional<bool>(*ssl_enabled) : std::nullopt),
...
EncodableList PigeonFirebaseSettings::ToEncodableList() const {
  ...
  list.push_back(ssl_enabled_ ? EncodableValue(*ssl_enabled_) : EncodableValue());
...
PigeonFirebaseSettings PigeonFirebaseSettings::FromEncodableList(const EncodableList& list) {
  PigeonFirebaseSettings decoded(
    std::get<bool>(list[4]));
...
void FirestorePigeonFirebaseApp::set_settings(const PigeonFirebaseSettings& value_arg) {
  settings_ = value_arg;
}
...
void FirestorePigeonFirebaseApp::set_database_u_r_l(std::string_view value_arg) {
...
FirestorePigeonFirebaseApp FirestorePigeonFirebaseApp::FromEncodableList(const EncodableList& list) {
  FirestorePigeonFirebaseApp decoded(
    std::get<std::string>(list[0]),
    PigeonFirebaseSettings::FromEncodableList(std::get<EncodableList>(list[1])),
...
PigeonSnapshotMetadata::PigeonSnapshotMetadata(
...
PigeonSnapshotMetadata PigeonSnapshotMetadata::FromEncodableList(const EncodableList& list) {
  PigeonSnapshotMetadata decoded(
    std::get<bool>(list[0]),
    std::get<bool>(list[1]));
  return decoded;
}
...
void PigeonDocumentSnapshot::set_metadata(const PigeonSnapshotMetadata& value_arg) {
  metadata_ = value_arg;
}
...
PigeonDocumentSnapshot PigeonDocumentSnapshot::FromEncodableList(const EncodableList& list) {
  PigeonDocumentSnapshot decoded(
    std::get<std::string>(list[0]),
...
void PigeonDocumentChange::set_document(const PigeonDocumentSnapshot& value_arg) {
  document_ = value_arg;
}
...
PigeonDocumentChange PigeonDocumentChange::FromEncodableList(const EncodableList& list) {
  PigeonDocumentChange decoded(
    (DocumentChangeType)(std::get<int32_t>(list[0])),
...
const ServerTimestampBehavior& PigeonGetOptions::server_timestamp_behavior() const {
  return server_timestamp_behavior_;
}

void PigeonGetOptions::set_server_timestamp_behavior(const ServerTimestampBehavior& value_arg) {
...
PigeonGetOptions PigeonGetOptions::FromEncodableList(const EncodableList& list) {
...
PigeonDocumentOption::PigeonDocumentOption(
 ...
 : merge_(merge ? std::optional<bool>(*merge) : std::nullopt),
    merge_fields_(merge_fields ? std::optional<EncodableList>(*merge_fields) : std::nullopt) {}
...
void PigeonDocumentOption::set_merge_fields(const EncodableList* value_arg) {
  merge_fields_ = value_arg ? std::optional<EncodableList>(*value_arg) : std::nullopt;
}
...
EncodableList PigeonDocumentOption::ToEncodableList() const {
  ...
  list.push_back(merge_fields_ ? EncodableValue(*merge_fields_) : EncodableValue());
  return list;
}

PigeonDocumentOption PigeonDocumentOption::FromEncodableList(const EncodableList& list) {
...
PigeonTransactionCommand::PigeonTransactionCommand(
 ...
 : type_(type),
    path_(path),
    data_(data ? std::optional<EncodableMap>(*data) : std::nullopt),
    option_(option ? std::optional<PigeonDocumentOption>(*option) : std::nullopt) {}

const PigeonTransactionType& PigeonTransactionCommand::type() const {
  return type_;
}

void PigeonTransactionCommand::set_type(const PigeonTransactionType& value_arg) {
  type_ = value_arg;
}
...
void PigeonTransactionCommand::set_option(const PigeonDocumentOption* value_arg) {
  option_ = value_arg ? std::optional<PigeonDocumentOption>(*value_arg) : std::nullopt;
}
...
EncodableList PigeonTransactionCommand::ToEncodableList() const {
  ...
  list.push_back(EncodableValue(path_));
  list.push_back(data_ ? EncodableValue(*data_) : EncodableValue());
  list.push_back(option_ ? EncodableValue(option_->ToEncodableList()) : EncodableValue());
  return list;
}

PigeonTransactionCommand PigeonTransactionCommand::FromEncodableList(const EncodableList& list) {
  ...
  if (!encodable_option.IsNull()) {
    decoded.set_option(PigeonDocumentOption::FromEncodableList(std::get<EncodableList>(encodable_option)));
  }
  return decoded;
}
...
DocumentReferenceRequest::DocumentReferenceRequest(
 ...
 : path_(path),
    ...
    server_timestamp_behavior_(server_timestamp_behavior ? std::optional<ServerTimestampBehavior>(*server_timestamp_behavior) : std::nullopt) {}
...
void DocumentReferenceRequest::set_option(const PigeonDocumentOption* value_arg) {
  option_ = value_arg ? std::optional<PigeonDocumentOption>(*value_arg) : std::nullopt;
}
...
const ServerTimestampBehavior* DocumentReferenceRequest::server_timestamp_behavior() const {
  return server_timestamp_behavior_ ? &(*server_timestamp_behavior_) : nullptr;
}

void DocumentReferenceRequest::set_server_timestamp_behavior(const ServerTimestampBehavior* value_arg) {
  server_timestamp_behavior_ = value_arg ? std::optional<ServerTimestampBehavior>(*value_arg) : std::nullopt;
}
...
EncodableList DocumentReferenceRequest::ToEncodableList() const {
  ...
  list.push_back(server_timestamp_behavior_ ? EncodableValue((int)(*server_timestamp_behavior_)) : EncodableValue());
  return list;
}

DocumentReferenceRequest DocumentReferenceRequest::FromEncodableList(const EncodableList& list) {
  DocumentReferenceRequest decoded(
    std::get<std::string>(list[0]));
  auto& encodable_data = list[1];
  if (!encodable_data.IsNull()) {
    decoded.set_data(std::get<EncodableMap>(encodable_data));
  ...
  if (!encodable_server_timestamp_behavior.IsNull()) {
    decoded.set_server_timestamp_behavior((ServerTimestampBehavior)(std::get<int32_t>(encodable_server_timestamp_behavior)));
  }
  return decoded;
}
...
PigeonQueryParameters::PigeonQueryParameters(
 ...
 : where_(where ? std::optional<EncodableList>(*where) : std::nullopt),
    order_by_(order_by ? std::optional<EncodableList>(*order_by) : std::nullopt),
    ...
    start_at_(start_at ? std::optional<EncodableList>(*start_at) : std::nullopt),
    start_after_(start_after ? std::optional<EncodableList>(*start_after) : std::nullopt),
    end_at_(end_at ? std::optional<EncodableList>(*end_at) : std::nullopt),
    end_before_(end_before ? std::optional<EncodableList>(*end_before) : std::nullopt),
...
void PigeonQueryParameters::set_order_by(const EncodableList* value_arg) {
  order_by_ = value_arg ? std::optional<EncodableList>(*value_arg) : std::nullopt;
}
...
void PigeonQueryParameters::set_start_at(const EncodableList* value_arg) {
  start_at_ = value_arg ? std::optional<EncodableList>(*value_arg) : std::nullopt;
}
...
void PigeonQueryParameters::set_start_after(const EncodableList* value_arg) {
  start_after_ = value_arg ? std::optional<EncodableList>(*value_arg) : std::nullopt;
}
...
void PigeonQueryParameters::set_end_before(const EncodableList* value_arg) {
  end_before_ = value_arg ? std::optional<EncodableList>(*value_arg) : std::nullopt;
}
...
EncodableList PigeonQueryParameters::ToEncodableList() const {
  ...
  list.push_back(start_after_ ? EncodableValue(*start_after_) : EncodableValue());
...
PigeonQueryParameters PigeonQueryParameters::FromEncodableList(const EncodableList& list) {
...
AggregateQuery AggregateQuery::FromEncodableList(const EncodableList& list) {
  AggregateQuery decoded(
    (AggregateType)(std::get<int32_t>(list[0])));
...
AggregateQueryResponse::AggregateQueryResponse(
  const AggregateType& type,
  const std::string* field,
  const double* value)
 : type_(type),
...
AggregateQueryResponse AggregateQueryResponse::FromEncodableList(const EncodableList& list) {
  AggregateQueryResponse decoded(
    (AggregateType)(std::get<int32_t>(list[0])));
  auto& encodable_field = list[1];
  if (!encodable_field.IsNull()) {
    decoded.set_field(std::get<std::string>(encodable_field));
...
FirebaseFirestoreHostApiCodecSerializer::FirebaseFirestoreHostApiCodecSerializer() {}
...
EncodableValue FirebaseFirestoreHostApiCodecSerializer::ReadValueOfType(
  ...
  switch (type) {
    case 128:
      return CustomEncodableValue(AggregateQuery::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 129:
      return CustomEncodableValue(AggregateQueryResponse::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 130:
      return CustomEncodableValue(DocumentReferenceRequest::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 131:
      return CustomEncodableValue(FirestorePigeonFirebaseApp::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 132:
      return CustomEncodableValue(PigeonDocumentChange::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 133:
      return CustomEncodableValue(PigeonDocumentOption::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 134:
      return CustomEncodableValue(PigeonDocumentSnapshot::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 135:
      return CustomEncodableValue(PigeonFirebaseSettings::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 136:
      return CustomEncodableValue(PigeonGetOptions::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 137:
      return CustomEncodableValue(PigeonQueryParameters::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 138:
      return CustomEncodableValue(PigeonQuerySnapshot::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 139:
      return CustomEncodableValue(PigeonSnapshotMetadata::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    case 140:
      return CustomEncodableValue(PigeonTransactionCommand::FromEncodableList(std::get<EncodableList>(ReadValue(stream))));
    default:
...
void FirebaseFirestoreHostApiCodecSerializer::WriteValue(
  ...
  if (const CustomEncodableValue* custom_value = std::get_if<CustomEncodableValue>(&value)) {
    if (custom_value->type() == typeid(AggregateQuery)) {
      ...
      WriteValue(EncodableValue(std::any_cast<AggregateQuery>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(AggregateQueryResponse)) {
      stream->WriteByte(129);
      WriteValue(EncodableValue(std::any_cast<AggregateQueryResponse>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(DocumentReferenceRequest)) {
      stream->WriteByte(130);
      WriteValue(EncodableValue(std::any_cast<DocumentReferenceRequest>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(FirestorePigeonFirebaseApp)) {
      stream->WriteByte(131);
      WriteValue(EncodableValue(std::any_cast<FirestorePigeonFirebaseApp>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonDocumentChange)) {
      stream->WriteByte(132);
      WriteValue(EncodableValue(std::any_cast<PigeonDocumentChange>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonDocumentOption)) {
      stream->WriteByte(133);
      WriteValue(EncodableValue(std::any_cast<PigeonDocumentOption>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonDocumentSnapshot)) {
      stream->WriteByte(134);
      WriteValue(EncodableValue(std::any_cast<PigeonDocumentSnapshot>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonFirebaseSettings)) {
      stream->WriteByte(135);
      WriteValue(EncodableValue(std::any_cast<PigeonFirebaseSettings>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonGetOptions)) {
      stream->WriteByte(136);
      WriteValue(EncodableValue(std::any_cast<PigeonGetOptions>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonQueryParameters)) {
      stream->WriteByte(137);
      WriteValue(EncodableValue(std::any_cast<PigeonQueryParameters>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonQuerySnapshot)) {
      stream->WriteByte(138);
      WriteValue(EncodableValue(std::any_cast<PigeonQuerySnapshot>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonSnapshotMetadata)) {
      stream->WriteByte(139);
      WriteValue(EncodableValue(std::any_cast<PigeonSnapshotMetadata>(*custom_value).ToEncodableList()), stream);
      return;
    }
    if (custom_value->type() == typeid(PigeonTransactionCommand)) {
      stream->WriteByte(140);
      WriteValue(EncodableValue(std::any_cast<PigeonTransactionCommand>(*custom_value).ToEncodableList()), stream);
      return;
    }
  }
...
const flutter::StandardMessageCodec& FirebaseFirestoreHostApi::GetCodec() {
  return flutter::StandardMessageCodec::GetInstance(&FirebaseFirestoreHostApiCodecSerializer::GetInstance());
}
...
void FirebaseFirestoreHostApi::SetUp(
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.loadBundle", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& app_arg = std::any_cast<const FirestorePigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          const auto& encodable_bundle_arg = args.at(1);
          if (encodable_bundle_arg.IsNull()) {
            reply(WrapError("bundle_arg unexpectedly null."));
            return;
          }
          const auto& bundle_arg = std::get<std::vector<uint8_t>>(encodable_bundle_arg);
          api->LoadBundle(app_arg, bundle_arg, [reply](ErrorOr<std::string>&& output) {
            if (output.has_error()) {
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.namedQueryGet", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& options_arg = std::any_cast<const PigeonGetOptions&>(std::get<CustomEncodableValue>(encodable_options_arg));
          api->NamedQueryGet(app_arg, name_arg, options_arg, [reply](ErrorOr<PigeonQuerySnapshot>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.clearPersistence", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_arg = std::any_cast<const FirestorePigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->ClearPersistence(app_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.disableNetwork", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_arg = std::any_cast<const FirestorePigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->DisableNetwork(app_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.enableNetwork", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_arg = std::any_cast<const FirestorePigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->EnableNetwork(app_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.terminate", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_arg = std::any_cast<const FirestorePigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->Terminate(app_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.waitForPendingWrites", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& app_arg = std::any_cast<const FirestorePigeonFirebaseApp&>(std::get<CustomEncodableValue>(encodable_app_arg));
          api->WaitForPendingWrites(app_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.setIndexConfiguration", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& index_configuration_arg = std::get<std::string>(encodable_index_configuration_arg);
          api->SetIndexConfiguration(app_arg, index_configuration_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.setLoggingEnabled", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& logging_enabled_arg = std::get<bool>(encodable_logging_enabled_arg);
          api->SetLoggingEnabled(logging_enabled_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.snapshotsInSyncSetup", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.transactionCreate", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.transactionStoreResult", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const PigeonTransactionResult& result_type_arg = (PigeonTransactionResult)encodable_result_type_arg.LongValue();
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.transactionGet", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          api->TransactionGet(app_arg, transaction_id_arg, path_arg, [reply](ErrorOr<PigeonDocumentSnapshot>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.documentReferenceSet", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& request_arg = std::any_cast<const DocumentReferenceRequest&>(std::get<CustomEncodableValue>(encodable_request_arg));
          api->DocumentReferenceSet(app_arg, request_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.documentReferenceUpdate", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& request_arg = std::any_cast<const DocumentReferenceRequest&>(std::get<CustomEncodableValue>(encodable_request_arg));
          api->DocumentReferenceUpdate(app_arg, request_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.documentReferenceGet", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& request_arg = std::any_cast<const DocumentReferenceRequest&>(std::get<CustomEncodableValue>(encodable_request_arg));
          api->DocumentReferenceGet(app_arg, request_arg, [reply](ErrorOr<PigeonDocumentSnapshot>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.documentReferenceDelete", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& request_arg = std::any_cast<const DocumentReferenceRequest&>(std::get<CustomEncodableValue>(encodable_request_arg));
          api->DocumentReferenceDelete(app_arg, request_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.queryGet", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& is_collection_group_arg = std::get<bool>(encodable_is_collection_group_arg);
          ...
          const auto& parameters_arg = std::any_cast<const PigeonQueryParameters&>(std::get<CustomEncodableValue>(encodable_parameters_arg));
          ...
          const auto& options_arg = std::any_cast<const PigeonGetOptions&>(std::get<CustomEncodableValue>(encodable_options_arg));
          api->QueryGet(app_arg, path_arg, is_collection_group_arg, parameters_arg, options_arg, [reply](ErrorOr<PigeonQuerySnapshot>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.aggregateQuery", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const AggregateSource& source_arg = (AggregateSource)encodable_source_arg.LongValue();
          const auto& encodable_queries_arg = args.at(4);
          if (encodable_queries_arg.IsNull()) {
            reply(WrapError("queries_arg unexpectedly null."));
            return;
          }
          const auto& queries_arg = std::get<EncodableList>(encodable_queries_arg);
          ...
          const auto& is_collection_group_arg = std::get<bool>(encodable_is_collection_group_arg);
          api->AggregateQuery(app_arg, path_arg, parameters_arg, source_arg, queries_arg, is_collection_group_arg, [reply](ErrorOr<EncodableList>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.writeBatchCommit", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& writes_arg = std::get<EncodableList>(encodable_writes_arg);
          api->WriteBatchCommit(app_arg, writes_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.querySnapshot", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          if (encodable_include_metadata_changes_arg.IsNull()) {
            reply(WrapError("include_metadata_changes_arg unexpectedly null."));
            return;
          }
          const auto& include_metadata_changes_arg = std::get<bool>(encodable_include_metadata_changes_arg);
          const auto& encodable_source_arg = args.at(6);
          if (encodable_source_arg.IsNull()) {
            reply(WrapError("source_arg unexpectedly null."));
            return;
          }
          const ListenSource& source_arg = (ListenSource)encodable_source_arg.LongValue();
          api->QuerySnapshot(app_arg, path_arg, is_collection_group_arg, parameters_arg, options_arg, include_metadata_changes_arg, source_arg, [reply](ErrorOr<std::string>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    auto channel = std::make_unique<BasicMessageChannel<>>(binary_messenger, "dev.flutter.pigeon.cloud_firestore_platform_interface.FirebaseFirestoreHostApi.documentReferenceSnapshot", &GetCodec());
    if (api != nullptr) {
      channel->SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& parameters_arg = std::any_cast<const DocumentReferenceRequest&>(std::get<CustomEncodableValue>(encodable_parameters_arg));
          ...
          const ListenSource& source_arg = (ListenSource)encodable_source_arg.LongValue();
          api->DocumentReferenceSnapshot(app_arg, parameters_arg, include_metadata_changes_arg, source_arg, [reply](ErrorOr<std::string>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
...
EncodableValue FirebaseFirestoreHostApi::WrapError(std::string_view error_message) {

...
class FirestorePigeonFirebaseApp {
 ...
 private:
  ...
  std::unique_ptr<PigeonFirebaseSettings> settings_;
...
class PigeonDocumentSnapshot {
 public:
  ...
  ~PigeonDocumentSnapshot() = default;
  PigeonDocumentSnapshot(const PigeonDocumentSnapshot& other);
  PigeonDocumentSnapshot& operator=(const PigeonDocumentSnapshot& other);
  PigeonDocumentSnapshot(PigeonDocumentSnapshot&& other) = default;
  PigeonDocumentSnapshot& operator=(PigeonDocumentSnapshot&& other) noexcept =
      default;
 ...
 private:
  ...
  std::unique_ptr<PigeonSnapshotMetadata> metadata_;
};
...
class PigeonDocumentChange {
 public:
  ...
  ~PigeonDocumentChange() = default;
  PigeonDocumentChange(const PigeonDocumentChange& other);
  PigeonDocumentChange& operator=(const PigeonDocumentChange& other);
  PigeonDocumentChange(PigeonDocumentChange&& other) = default;
  PigeonDocumentChange& operator=(PigeonDocumentChange&& other) noexcept =
      default;
 ...
 private:
  ...
  std::unique_ptr<PigeonDocumentSnapshot> document_;
  int64_t old_index_;
  int64_t new_index_;
};
...
class PigeonQuerySnapshot {
 public:
  ...
  ~PigeonQuerySnapshot() = default;
  PigeonQuerySnapshot(const PigeonQuerySnapshot& other);
  PigeonQuerySnapshot& operator=(const PigeonQuerySnapshot& other);
  PigeonQuerySnapshot(PigeonQuerySnapshot&& other) = default;
  PigeonQuerySnapshot& operator=(PigeonQuerySnapshot&& other) noexcept =
      default;
...
class PigeonTransactionCommand {
 public:
  ...
  ~PigeonTransactionCommand() = default;
  PigeonTransactionCommand(const PigeonTransactionCommand& other);
  PigeonTransactionCommand& operator=(const PigeonTransactionCommand& other);
  PigeonTransactionCommand(PigeonTransactionCommand&& other) = default;
  PigeonTransactionCommand& operator=(
      PigeonTransactionCommand&& other) noexcept = default;
 ...
 private:
  ...
  std::string path_;
  std::optional<flutter::EncodableMap> data_;
  std::unique_ptr<PigeonDocumentOption> option_;
};
...
class PigeonCodecSerializer : public cloud_firestore_windows::FirestoreCodec {
 public:

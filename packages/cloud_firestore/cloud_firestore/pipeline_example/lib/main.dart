...
class _PipelineExamplePageState extends State<PipelineExamplePage> {
  ...
  Future<void> _runPipeline22() => _runPipeline(
        ...
        () => _firestore
            ...
            .collection(_collectionId)
            .addFields(
              Expression.field('title').concat(
                  [' | ', Expression.field('category')]).as('title_category'),
            )
            .limit(3)
            .execute(),
      );
  ...
  Future<void> _runPipeline23() => _runPipeline(
        ...
        () => _firestore
            ...
            .collection(_collectionId)
            .addFields(
              Expression.field('title').length().as('title_len'),
            )
            .limit(4)
            .execute(),
      );
  ...
  Future<void> _runPipeline25() => _runPipeline(
        ...
        () => _firestore
            ...
            .addFields(
              Expression.field('title').trim().as('title_trimmed'),
            )
            .limit(5)
            .execute(),
      );
  ...
  Future<void> _runPipeline30() => _runPipeline(
        ...
        () => _firestore
            ...
            .collection(_collectionId)
            .addFields(
              Expression.field('optional_field')
                  .ifAbsentValue('default')
                  .as('opt_or_default'),
            )
            .limit(4)
            .execute(),
  ...
  Future<void> _runPipeline36() => _runPipeline(
        ...
        () => _firestore
            ...
            .collection(_collectionId)
            .addFields(
              Expression.field('score').abs().as('score_abs'),
            )
            .limit(5)
            .execute(),
      );
  ...
  Future<void> _runPipeline37b() => _runPipeline(
        ...
        () => _firestore
            ...
            .addFields(
              Expression.field('scores').arraySum().as('scores_total'),
            )
            .limit(3)
            .execute(),
      );
  ...
  Future<void> _runPipeline42() => _runPipeline(
        ...
        () => _firestore
            ...
            .collection(_collectionId)
            .where(
              Expression.field('tags').arrayContainsAll(['x', 'y']),
            )
            .select(
              Expression.field('title'),
              Expression.field('tags'),

...
- (void)aggregateQueryApp:(nonnull FirestorePigeonFirebaseApp *)app path:(nonnull NSString *)path parameters:(nonnull PigeonQueryParameters *)parameters source:(AggregateSource)source queries:(nonnull NSArray<AggregateQuery *> *)queries completion:(nonnull void (^)(NSArray<AggregateQueryResponse *> * _Nullable, FlutterError * _Nullable))completion { 
    FIRFirestore *firestore = [self getFIRFirestoreFromAppNameFromPigeon:app];
    ...
    for (AggregateQuery *queryRequest in queries) {
        switch ([queryRequest type]) {
            ...
            case AggregateTypeSum:
                [aggregateFields addObject:[FIRAggregateField aggregateFieldForSumOfField:[queryRequest field]]];
                break;
            case AggregateTypeAverage:
                [aggregateFields addObject:[FIRAggregateField aggregateFieldForAverageOfField:[queryRequest field]]];
                break;
            default:
    ...
    [aggregateQuery aggregationWithSource:FIRAggregateSourceServer
        ...
        NSMutableArray<AggregateQueryResponse *>* aggregateResponses = [[NSMutableArray alloc] init];

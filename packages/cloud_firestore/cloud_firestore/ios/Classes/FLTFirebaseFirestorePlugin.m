...
NSString *const kFLTFirebaseFirestoreChannelName =
...
///
/// Once registered, the plugin will take care of removing the stream handler
/// and cleaning up, if the engine is detached.
///
/// This function generates a random ID.
///
/// @param prefix Channel prefix onto which the unique ID will be appended on.
/// The convention is
///     "namespace/component" whereas the last / is added internally.
/// @param handler The handler object for responding to channel events and
/// submitting data.
...
///
/// @param prefix Channel prefix onto which the unique ID will be appended on.
/// The convention is "namespace/component" whereas the last / is added
/// internally.
...
@implementation FLTFirebaseFirestorePlugin {
  ...
  NSMutableDictionary<NSString *, NSObject<FlutterStreamHandler> *>
      *_streamHandlers;
  NSMutableDictionary<NSString *, FLTTransactionStreamHandler *>
...
+ (void)initialize {
  _codec = [FlutterStandardMethodCodec
      codecWithReaderWriter:[FLTFirebaseFirestoreReaderWriter new]];
}
...
- (instancetype)init:(NSObject<FlutterBinaryMessenger> *)messenger {
  ...
  if (self) {
    ...
    _transactions =
        [NSMutableDictionary<NSNumber *, FIRTransaction *> dictionary];
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  FlutterMethodChannel *channel = [FlutterMethodChannel
      methodChannelWithName:kFLTFirebaseFirestoreChannelName
...
- (void)cleanupWithCompletion:(void (^)(void))completion {
  ...
  void (^firestoreTerminateInstanceCompletion)(NSError *) =
      ^void(NSError *error) {
        instancesTerminated++;
      ...
      dispatch_async(
          dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
            [[FIRFirestore firestoreForApp:app]
                terminateWithCompletion:^(NSError *error) {
                  [FLTFirebaseFirestoreUtils
                      destroyCachedFIRFirestoreInstanceForKey:appName];
...
- (void)handleMethodCall:(FlutterMethodCall *)call
  ...
  FLTFirebaseMethodCallErrorBlock errorBlock = ^(
    ...
    if ([@"unknown" isEqualToString:code]) {
      NSLog(@"FLTFirebaseFirestore: An error occurred while calling method %@",
            call.method);
    }
...
- (void)setupSnapshotsInSyncListener:(id)arguments
  ...
  result.success([self
      registerEventChannelWithPrefix:
          kFLTFirebaseFirestoreSnapshotsInSyncEventChannelName
...
- (void)setupDocumentReferenceSnapshotsListener:(id)arguments
  ...
  result.success([self
      registerEventChannelWithPrefix:
          kFLTFirebaseFirestoreDocumentSnapshotEventChannelName
...
- (void)setupQuerySnapshotsListener:(id)arguments
  ...
  result.success([self
      registerEventChannelWithPrefix:
          kFLTFirebaseFirestoreQuerySnapshotEventChannelName
...
- (void)clearPersistence:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  FIRFirestore *firestore = arguments[@"firestore"];
...
- (void)terminate:(id)arguments
  ...
  [firestore terminateWithCompletion:^(NSError *error) {
    if (error != nil) {
      ...
      [FLTFirebaseFirestoreUtils
          destroyCachedFIRFirestoreInstanceForKey:firestore.app.name];
      result.success(nil);
    }
  }];
}

- (void)enableNetwork:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  FIRFirestore *firestore = arguments[@"firestore"];
...
- (void)disableNetwork:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  FIRFirestore *firestore = arguments[@"firestore"];
...
- (void)transactionGet:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  dispatch_async(
      dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        FIRDocumentSnapshot *snapshot = [transaction getDocument:document
                                                           error:&error];
...
- (void)transactionCreate:(id)arguments
     withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  ...
  result.success([self
      registerEventChannelWithPrefix:kFLTFirebaseFirestoreTransactionChannelName
...
- (void)transactionStoreResult:(id)arguments
  ...
  [_transactionHandlers[transactionId]
      receiveTransactionResponse:transactionResult];

  result.success(nil);
}

- (void)documentSet:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
...
- (void)documentUpdate:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  id data = arguments[@"data"];
  FIRDocumentReference *document = arguments[@"reference"];
...
- (void)documentDelete:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  FIRDocumentReference *document = arguments[@"reference"];
...
- (void)queryGet:(id)arguments
  ...
  if (query == nil) {
    result.error(@"sdk-error",
                 @"An error occurred while parsing query arguments, see native "
                 @"logs for more "
...
- (void)namedQueryGet:(id)arguments
    withMethodCallResult:(FLTFirebaseMethodCallResult *)result {
  FIRFirestore *firestore = arguments[@"firestore"];
         ...
         completion:^(FIRQuery *_Nullable query) {
           if (query == nil) {
             result.error(@"non-existent-named-query",
                          @"Named query has not been found. Please check it "
                          @"has been loaded "
...
- (NSString *)registerEventChannelWithPrefix:(NSString *)prefix
  ...
  NSString *channelName =
      [NSString stringWithFormat:@"%@/%@", prefix, identifier];

  FlutterEventChannel *channel =
      [[FlutterEventChannel alloc] initWithName:channelName

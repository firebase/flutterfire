...
- (void)snapshotsInSyncSetupApp:(PigeonFirebaseApp *)app completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
...
- (void)aggregateQueryCountApp:(PigeonFirebaseApp *)app path:(NSString *)path parameters:(PigeonQueryParameters *)parameters source:(AggregateSource)source completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
...
- (void)querySnapshotApp:(PigeonFirebaseApp *)app path:(NSString *)path isCollectionGroup:(NSNumber *)isCollectionGroup parameters:(PigeonQueryParameters *)parameters options:(PigeonGetOptions *)options includeMetadataChanges:(NSNumber *)includeMetadataChanges completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
- (void)documentReferenceSnapshotApp:(PigeonFirebaseApp *)app parameters:(DocumentReferenceRequest *)parameters includeMetadataChanges:(NSNumber *)includeMetadataChanges completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end

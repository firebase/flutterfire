...
- (FlutterError *_Nullable)onListenWithArguments:(id _Nullable)arguments
  ...
  if (query == nil) {
    return [FlutterError errorWithCode:@"sdk-error"
                               message:@"An error occurred while parsing query "
                                       @"arguments, see native logs for more "
  ...
  self.listenerRegistration = [query

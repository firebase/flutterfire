...
- (void)querySnapshotApp:(FirestorePigeonFirebaseApp *)app path:(NSString *)path isCollectionGroup:(NSNumber *)isCollectionGroup parameters:(PigeonQueryParameters *)parameters options:(PigeonGetOptions *)options includeMetadataChanges:(NSNumber *)includeMetadataChanges completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
- (void)documentReferenceSnapshotApp:(FirestorePigeonFirebaseApp *)app parameters:(DocumentReferenceRequest *)parameters includeMetadataChanges:(NSNumber *)includeMetadataChanges completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end

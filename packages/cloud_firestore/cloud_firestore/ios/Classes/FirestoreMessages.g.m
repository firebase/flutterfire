  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:FirebaseFirestoreHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(querySnapshotApp:path:isCollectionGroup:parameters:options:includeMetadataChanges:completion:)], @"FirebaseFirestoreHostApi api (%@) doesn't respond to @selector(querySnapshotApp:path:isCollectionGroup:parameters:options:includeMetadataChanges:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FirestorePigeonFirebaseApp *arg_app = GetNullableObjectAtIndex(args, 0);
        NSString *arg_path = GetNullableObjectAtIndex(args, 1);
        ...
        [api querySnapshotApp:arg_app path:arg_path isCollectionGroup:arg_isCollectionGroup parameters:arg_parameters options:arg_options includeMetadataChanges:arg_includeMetadataChanges completion:^(NSString *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:FirebaseFirestoreHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(documentReferenceSnapshotApp:parameters:includeMetadataChanges:completion:)], @"FirebaseFirestoreHostApi api (%@) doesn't respond to @selector(documentReferenceSnapshotApp:parameters:includeMetadataChanges:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FirestorePigeonFirebaseApp *arg_app = GetNullableObjectAtIndex(args, 0);
        ...
        [api documentReferenceSnapshotApp:arg_app parameters:arg_parameters includeMetadataChanges:arg_includeMetadataChanges completion:^(NSString *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {

...
The web implementation of [`firebase_messaging`][1].

## Usage

### Import the package

This package is the endorsed implementation of `firebase_messaging` for the web platform since version `6.0.15`.
...
Add `firebase_messaging_sw.dart.js` file to your app `web` directory.
...
Once you have modified your `web/index.html` file you should be able to use `package:firebase_messaging` as normal.

#### Examples

* The `example` app in `package:firebase_messaging` has an implementation of this instructions.

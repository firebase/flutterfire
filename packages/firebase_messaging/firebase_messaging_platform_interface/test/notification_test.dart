...
void main() {
  group('RemoteNotification', () {
    ...
    test(
      '"RemoteNotification.fromMap" with every possible property expected',
      () {
        Map<String, dynamic> mockNotificationMap = {
          'title': 'title',
          'titleLocArgs': ['titleLocArgs'],
  ...
  group('AndroidNotification', () {
    ...
    test(
      '"AndroidNotification.fromMap" with every possible property expected',
      () {
  ...
  group('AppleNotification', () {
    test('Provide every type of argument', () {
      ...
      expect(
        notification.subtitleLocArgs,
        appleNotificationMap['subtitleLocArgs'],
      );
      expect(
        notification.subtitleLocKey,
        appleNotificationMap['subtitleLocKey'],
      );
    });
    ...
    test(
      '"AppleNotification.fromMap" with every possible property expected',
      () {
        Map<String, dynamic> appleNotificationMap = {
          'badge': 'badge',
          'sound': {},
    ...
    test(
      ...
      () {
        ...
        expect(
          notification.subtitleLocArgs,
          defaultNotification.subtitleLocArgs,
        );
  ...
  group('AppleNotificationSound', () {
    ...
    test(
      ...
      () {
        ...
        const AppleNotificationSound defaultAppleSound =
    ...
    test(
      'AppleNotificationSound.toMap returns "AppleNotificationSound" as Map',
      () {
    ...
    test(
      ...
      () {
        ...
        expect(
          ...
          defaultWebNotification.analyticsLabel,
        );

...
class MethodChannelFirebaseMessaging extends FirebaseMessagingPlatform {
  ...
  Future<void> subscribeToTopic(String topic) {
    return channel.invokeMethod<void>('subscribeToTopic', topic);
  }

  /// Unsubscribe from topic in background.
  Future<void> unsubscribeFromTopic(String topic) {
    return channel.invokeMethod<void>('unsubscribeFromTopic', topic);
  }
  ...
  Future<bool> deleteInstanceID() async {
    return await channel.invokeMethod<bool>('deleteInstanceID');
  }

  /// Determine whether FCM auto-initialization is enabled or disabled.
  Future<bool> autoInitEnabled() async {
    return await channel.invokeMethod<bool>('autoInitEnabled');
  }

  /// Enable or disable auto-initialization of Firebase Cloud Messaging.
  Future<void> setAutoInitEnabled(bool enabled) async {
    await channel.invokeMethod<void>('setAutoInitEnabled', enabled);
  }

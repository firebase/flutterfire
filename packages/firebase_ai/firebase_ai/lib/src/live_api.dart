...
LiveServerResponse parseServerResponse(Object jsonObject) {
  ...
  if (json.containsKey('usageMetadata')) {
    usageMetadata = parseUsageMetadata(json['usageMetadata']);
  }
...
LiveServerMessage _parseServerMessage(Object jsonObject) {
  ...
  if (json.containsKey('serverContent')) {
    ...
    if (serverContentJson.containsKey('outputTranscription')) {
      final transcriptionJson = serverContentJson['outputTranscription'] as Map<String, dynamic>;
    ...
    if (serverContentJson.containsKey('inputTranscription')) {
      final transcriptionJson = serverContentJson['inputTranscription'] as Map<String, dynamic>;

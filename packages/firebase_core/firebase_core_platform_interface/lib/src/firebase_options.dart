...
class FirebaseOptions {
  ...
  /// Reserved as a placeholder to maintain alignment with the FlutterFire CLI.
  ///
  /// **Note:** This field is currently non-functional and does not take effect in the active runtime.
  /// It is preserved strictly to prevent breaking changes and ensure compatibility with
  /// configuration files generated by the CLI.

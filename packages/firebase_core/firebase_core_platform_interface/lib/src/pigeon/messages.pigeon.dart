...
class FirebaseCoreHostApi {
  ...
  Future<List<CoreInitializeResponse>> initializeCore() async {
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as List<Object?>?)!.cast<CoreInitializeResponse>();
    }
  }
...
class FirebaseAppHostApi {
  ...
  Future<void> registerLibrary(String library, String version, String platform) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.firebase_core_platform_interface.FirebaseAppHostApi.registerLibrary$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[library, version, platform]);
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);

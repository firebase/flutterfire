...
public typealias FLTFirebaseMethodCallErrorBlock = (String?, String?, [String: Any]?, Error?) -> Void
...
@objc public class FLTFirebaseMethodCallResult: NSObject {
    ...
    @objc public static func create(success: @escaping FLTFirebaseMethodCallSuccessBlock,
                                   andErrorBlock error: @escaping FLTFirebaseMethodCallErrorBlock) -> FLTFirebaseMethodCallResult {
        return FLTFirebaseMethodCallResult(success: success, error: error)
    }
}
...
@objc open class FLTFirebasePluginHelper: NSObject {
    ...
    @objc public static func firebaseAppName(fromDartName appName: String) -> String {
        return appName == kFIRDefaultAppNameDart ? kFIRDefaultAppNameIOS : appName
    }
    ...
    @objc public static func firebaseAppName(fromIosName appName: String) -> String {
        return appName == kFIRDefaultAppNameIOS ? kFIRDefaultAppNameDart : appName
    }

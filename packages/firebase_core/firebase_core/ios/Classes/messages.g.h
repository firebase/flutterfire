...
@interface PigeonInitializeReponse : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
- (void)initializeAppAppName:(NSString *)appName initializeAppRequest:(PigeonFirebaseOptions *)initializeAppRequest completion:(void(^)(PigeonInitializeReponse *_Nullable, FlutterError *_Nullable))completion;
- (void)initializeCoreWithCompletion:(void(^)(NSArray<PigeonInitializeReponse *> *_Nullable, FlutterError *_Nullable))completion;
- (void)optionsFromResourceWithCompletion:(void(^)(PigeonFirebaseOptions *_Nullable, FlutterError *_Nullable))completion;
@end

extern void FirebaseCoreHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FirebaseCoreHostApi> *_Nullable api);
...
- (void)setAutomaticDataCollectionEnabledAppName:(NSString *)appName enabled:(NSNumber *)enabled completion:(void(^)(FlutterError *_Nullable))completion;
- (void)setAutomaticResourceManagementEnabledAppName:(NSString *)appName enabled:(NSNumber *)enabled completion:(void(^)(FlutterError *_Nullable))completion;
- (void)deleteAppName:(NSString *)appName completion:(void(^)(FlutterError *_Nullable))completion;
@end

extern void FirebaseAppHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FirebaseAppHostApi> *_Nullable api);

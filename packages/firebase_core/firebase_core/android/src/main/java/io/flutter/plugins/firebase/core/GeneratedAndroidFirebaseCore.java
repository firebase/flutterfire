...
public class GeneratedAndroidFirebaseCore {
  ...
  public static final class CoreFirebaseOptions {
    ...
    @Override
    public int hashCode() {
      Object[] fields = new Object[] {getClass(), apiKey, appId, messagingSenderId, projectId, authDomain, databaseURL, storageBucket, measurementId, trackingId, deepLinkURLScheme, androidClientId, iosClientId, iosBundleId, appGroupId, recaptchaSiteKey};

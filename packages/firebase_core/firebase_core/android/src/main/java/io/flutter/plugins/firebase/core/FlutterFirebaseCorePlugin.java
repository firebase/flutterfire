...
public class FlutterFirebaseCorePlugin implements FlutterPlugin, GeneratedAndroidFirebaseCore.FirebaseCoreHostApi, GeneratedAndroidFirebaseCore.FirebaseAppHostApi {
  ...
  private Task<GeneratedAndroidFirebaseCore.PigeonInitializeReponse> firebaseAppToMap(FirebaseApp firebaseApp) {
  ...
  @Override
  public void initializeApp(@NonNull String appName, @NonNull GeneratedAndroidFirebaseCore.PigeonFirebaseOptions initializeAppRequest, GeneratedAndroidFirebaseCore.Result<GeneratedAndroidFirebaseCore.PigeonInitializeReponse> result) {
    TaskCompletionSource<GeneratedAndroidFirebaseCore.PigeonInitializeReponse> taskCompletionSource = new TaskCompletionSource<>();
    ...
    cachedThreadPool.execute(
      () -> {
        try {
          ...
          FirebaseApp firebaseApp = FirebaseApp.initializeApp(applicationContext, options, appName);
  ...
  @Override
  public void initializeCore(GeneratedAndroidFirebaseCore.Result<List<GeneratedAndroidFirebaseCore.PigeonInitializeReponse>> result) {
    TaskCompletionSource<List<GeneratedAndroidFirebaseCore.PigeonInitializeReponse>> taskCompletionSource =
    ...
    cachedThreadPool.execute(
      () -> {
        try {
          ...
          List<GeneratedAndroidFirebaseCore.PigeonInitializeReponse> firebaseAppsList = new ArrayList<>(firebaseApps.size());
  ...
  public void optionsFromResource(GeneratedAndroidFirebaseCore.Result<GeneratedAndroidFirebaseCore.PigeonFirebaseOptions> result) {
    TaskCompletionSource<GeneratedAndroidFirebaseCore.PigeonFirebaseOptions> taskCompletionSource = new TaskCompletionSource<>();
  ...
  @Override
  public void setAutomaticDataCollectionEnabled(@NonNull String appName, @NonNull Boolean enabled, GeneratedAndroidFirebaseCore.Result<Void> result) {
  ...
  @Override
  public void setAutomaticResourceManagementEnabled(@NonNull String appName, @NonNull Boolean enabled, GeneratedAndroidFirebaseCore.Result<Void> result) {
    TaskCompletionSource<Void> taskCompletionSource = new TaskCompletionSource<>();

...
CoreFirebaseOptions::CoreFirebaseOptions(
 ...
 : api_key_(api_key),
    ...
    recaptcha_site_key_(recaptcha_site_key ? std::optional<std::string>(*recaptcha_site_key) : std::nullopt) {}
...
void CoreFirebaseOptions::set_recaptcha_site_key(const std::string_view* value_arg) {
  recaptcha_site_key_ = value_arg ? std::optional<std::string>(*value_arg) : std::nullopt;
}
...
EncodableList CoreFirebaseOptions::ToEncodableList() const {
  ...
  list.push_back(recaptcha_site_key_ ? EncodableValue(*recaptcha_site_key_) : EncodableValue());
  return list;
}

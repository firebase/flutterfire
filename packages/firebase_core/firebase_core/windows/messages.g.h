...
class PigeonFirebaseOptions {
 public:
  ...
  explicit PigeonFirebaseOptions(const std::string& api_key,
 ...
 private:
  static PigeonFirebaseOptions FromEncodableList(
...
class PigeonInitializeResponse {
 ...
 private:
  static PigeonInitializeResponse FromEncodableList(
      const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class FirebaseCoreHostApi;
  friend class FirebaseCoreHostApiCodecSerializer;

...
class EsLocalizations extends FlutterFireUILocalizationLabels {
  ...
  const EsLocalizations({
    ...
    this.signInButtonText = 'Ingresar',
    this.registerButtonText = 'Registrarse',
    this.linkEmailButtonText = 'Siguiente',
    this.signInWithPhoneButtonText = 'Entra con phone',
    ...
    this.forgotPasswordViewTitle = 'Olvidar contraseña',
    ...
    this.codeRequiredErrorText = 'El código de país es requerido',

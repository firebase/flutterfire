...
class NlLocalizations extends FlutterFireUILocalizationLabels {
  ...
  const NlLocalizations({
    ...
    this.registerActionText = 'Registreer',
    this.signInButtonText = 'Login',
    this.registerButtonText = 'Registreer',
    this.linkEmailButtonText = 'Verder',
    this.signInWithPhoneButtonText = 'Login met telefoon',
    this.signInWithGoogleButtonText = 'Login met Google',
    this.signInWithAppleButtonText = 'Login met Apple',
    this.signInWithTwitterButtonText = 'Login met Twitter',
    this.signInWithFacebookButtonText = 'Login met Facebook',
    ...
    this.registerText = 'Registreer',
    this.registerHintText = 'Nog geen account?',
    ...
    this.emailLinkSignInButtonLabel = 'Login met een magic link',
    this.signInWithEmailLinkViewTitleText = 'Login met een magic link',

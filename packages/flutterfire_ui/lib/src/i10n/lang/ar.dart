...
class ArLocalizations extends FlutterFireUILocalizationLabels {
  ...
  const ArLocalizations({
    ...
    this.verifyingPhoneNumberViewTitle = 'أدخل الرمز المرسل كرسالة نصية',
    ...
    this.smsCodeSentText = 'تم إرسال الرمز كرسالة نصية',
    ...
    this.emailTakenErrorText = 'الحساب الذي تحاول تسجيله موجود مسبقاً',
    ...
    this.goBackButtonLabel = 'عودة للخلف',
    ...
    this.emailLinkSignInButtonLabel = 'تسجيل الدخول باستخدام الرابط السحري',
    this.signInWithEmailLinkViewTitleText =
        'تسجيل الدخول باستخدام الرابط السحري',
    this.signInWithEmailLinkSentText =
        'أرسلنا لك رسال على البريد الإلكتروني تحتوي رابطاً سحرياً. تفقد صندوق رسائلك واضغط على الرابط لتسجيل الدخول',
    this.sendLinkButtonLabel = 'أرسل الرابط السحري',

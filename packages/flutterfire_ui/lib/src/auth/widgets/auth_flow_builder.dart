...
/// {@template ffui.auth.widgets.auth_flow_builder.auth_flow_builder_callback}
...
/// {@template ffui.auth.widgets.auth_flow_builder.state_transition_listener}
...
/// {@template ffui.auth.widgets.auth_flow_builder}
...
class AuthFlowBuilder<T extends AuthController> extends StatefulWidget {
  ...
  /// {@macro ffui.auth.widgets.auth_flow_builder.auth_flow_builder_callback}
  ...
  /// {@macro ffui.auth.widgets.auth_flow_builder.state_transition_listener}
  final StateTransitionListener<T>? listener;

  /// {@macro ffui.auth.widgets.auth_flow_builder}

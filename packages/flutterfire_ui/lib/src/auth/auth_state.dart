...
/// {@template ffui.auth.auth_state.uninitialized}
...
/// {@template ffui.auth.auth_state.signing_in}
...
class SigningIn extends AuthState {
  /// {@macro ffui.auth.auth_state.signing_in}
  const SigningIn();
}

/// {@template ffui.auth.auth_state.credential_received}
...
/// {@template ffui.auth.auth_state.credential_linked}
...
class CredentialLinked extends AuthState {
  ...
  /// {@macro ffui.auth.auth_state.credential_linked}
  CredentialLinked(this.credential);
}

/// {@template ffui.auth.auth_state.auth_failed}
...
class AuthFailed extends AuthState {
  ...
  /// {@macro ffui.auth.auth_state.auth_failed}
  AuthFailed(this.exception);
}

/// {@template ffui.auth.auth_state.signed_in}
...
class SignedIn extends AuthState {
  ...
  /// {@macro ffui.auth.auth_state.signed_in}
  SignedIn(this.user);
}

/// {@template ffui.auth.auth_state.different_sign_in_methods_found}
...
class DifferentSignInMethodsFound extends AuthState {
  ...
  /// {@macro ffui.auth.auth_state.different_sign_in_methods_found}
  DifferentSignInMethodsFound(this.email, this.methods, this.credential);
}

/// {@template ffui.auth.auth_state.fetching_providers_for_email}
...
class FetchingProvidersForEmail extends AuthState {
  /// {@macro ffui.auth.auth_state.fetching_providers_for_email}
...
/// {@template ffui.auth.auth_state.auth_state_transition}
...
class AuthStateTransition<T extends AuthController> extends Notification {
  ...
  /// {@macro ffui.auth.auth_state.auth_state_transition}}
...
/// {@template ffui.auth.auth_state.auth_state_listener}

...
You will also need to install [`flutterfire_ui_oauth_google`](https://pub.dev/packages/flutterfire_ui_oauth_google):
...
You will also need to install [`flutterfire_ui_oauth_apple`](https://pub.dev/packages/flutterfire_ui_oauth_apple):
...
You will also need to install [`flutterfire_ui_oauth_facebook`](https://pub.dev/packages/flutterfire_ui_oauth_facebook):
...
You will also need to install [`flutterfire_ui_oauth_twitter`](https://pub.dev/packages/flutterfire_ui_oauth_twitter):

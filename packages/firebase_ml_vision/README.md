...
If you're using the on-device `Object Detection`, include the latest matching [ML Kit: Object Detection Model](https://firebase.google.com/support/release-notes/android) dependency in your app-level build.gradle file.
...
android {
    dependencies {
        ...
        api 'com.google.firebase:firebase-ml-vision-object-detection-model:19.0.5'
    }
}
```

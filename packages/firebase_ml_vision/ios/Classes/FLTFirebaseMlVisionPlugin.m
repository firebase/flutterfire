...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
  if ([@"BarcodeDetector#detectInImage" isEqualToString:call.method] ||
      ...
      [@"LandmarkDetector#processImage" isEqualToString:call.method]) {
    [self handleDetection:call result:result];
             ...
             [@"LandmarkDetector#close" isEqualToString:call.method]) {
...
- (void)handleDetection:(FlutterMethodCall *)call result:(FlutterResult)result {
  ...
  if (!detector) {
    ...
    } else if ([call.method hasPrefix:@"LandmarkDetector"]) {
      detector = [[LandmarkDetector alloc] initWithVision:[FIRVision vision] options:options];
    }

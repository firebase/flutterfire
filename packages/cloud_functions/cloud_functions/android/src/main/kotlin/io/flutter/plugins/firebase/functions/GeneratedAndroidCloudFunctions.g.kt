...
interface CloudFunctionsHostApi {
  ...
  companion object {
    ...
    val codec: MessageCodec<Any?> by lazy { GeneratedAndroidCloudFunctionsPigeonCodec() }
    /**
    ...
    fun setUp(
      ...
      run {
        val channel =
            BasicMessageChannel<Any?>(
                binaryMessenger,
                "dev.flutter.pigeon.cloud_functions_platform_interface.CloudFunctionsHostApi.call$separatedMessageChannelSuffix",
                codec)
        if (api != null) {
      ...
      run {
        val channel =
            BasicMessageChannel<Any?>(
                binaryMessenger,
                "dev.flutter.pigeon.cloud_functions_platform_interface.CloudFunctionsHostApi.registerEventChannel$separatedMessageChannelSuffix",
                codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>

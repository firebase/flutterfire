    ...
    <Layout title={siteConfig.title} description={siteConfig.tagline}>
      ...
      <main>
            ...
            <tbody>
              {plugins.map((plugin: Plugin) => (
                <tr key={plugin.pub}>
                  ...
                  <td>
                    <a
                      href={
                        plugin.remoteSource
                          ? plugin.remoteSource
                          : `https://github.com/FirebaseExtended/flutterfire/tree/master/packages/${plugin.pub}`
                      }
                      target="_blank"
                      rel="noreferrer"
                    >
                  ...
                  <td>{plugin.production ? <b>Stable</b> : <i>Beta</i>}</td>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: '20px' }}>
          The FlutterFire AdMob package is deprecated and will be removed in the future. We
          recommend switching to the official &nbsp;
          <a href="https://pub.dev/packages/google_mobile_ads" target="_blank" rel="noreferrer">
            google_mobile_ads
          </a>
          &nbsp; package by Google. A migration guide is available &nbsp;
          <a

...
correctly setup [android](https://firebase.flutter.dev/docs/dynamic-links/android-integration) & [apple](https://firebase.flutter.dev/docs/dynamic-links/apple-integration).

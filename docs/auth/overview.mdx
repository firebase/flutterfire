...
> Additional documentation will be available once the Firebase Auth plugin update lands as part of the [FlutterFire roadmap](https://github.com/FirebaseExtended/flutterfire/issues/2582).

...
September 10: Be aware that this documentation is newer than current stable version (0.18.0+1).  If you want to follow these instructions with flutter web , you must fetch newer versin from repository. See "Note for users of Flutter Web".
...
#### Note for users of Flutter Web

firebase_auth: 0.18.0+1 is older than this documentation.
Add these to you pubspec.yaml until these features are published
```
dependencies:
  flutter:
    sdk: flutter

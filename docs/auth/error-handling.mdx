...
[https://firebase.google.com/docs/auth/flutter/errors](https://firebase.google.com/docs/auth/flutter/errors)

:::

The Firebase Authentication SDKs provide a simple way for catching the various errors which may occur which using
authentication methods. The SDKs for Flutter expose these errors via the [`FirebaseAuthException`](!firebase_auth_platform_interface.FirebaseAuthException)
class.

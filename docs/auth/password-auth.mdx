---
title: Authenticate with Firebase using Password-Based Accounts on Flutter
sidebar_label: Password Auth
---
...
:::caution
When a user uninstalls your app on iOS or macOS, the user's authentication

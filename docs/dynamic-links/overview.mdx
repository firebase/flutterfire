...
Once installed, you ought to follow the platform specific setup for [android](android-integration.mdx) or [iOS](apple-integration.mdx)
before heading over to the [Usage documentation](usage.mdx).

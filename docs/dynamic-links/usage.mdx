...
Alternatively, if you wish to select an exact dynamic link from your application, you may also pass the pressed URL to [`FirebaseDynamicLinks.getDynamicLink`](!firebase_dynamic_links.getDynamicLink)
like so:

---
title: Receive Firebase Dynamic Links in a Flutter app
sidebar_label: Receive Links
---
...
To receive the Firebase Dynamic Links that <a href="https://firebase.google.com/docs/dynamic-links/create-links">you created</a>,
...
1.  In Xcode, do the following:
    ...
    1.  **Optional:** Disable the Dynamic Links SDK's use of the iOS pasteboard.
        ...
        :::caution
        When you disable this feature, the Dynamic Links you receive will have

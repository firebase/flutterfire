---
title: Get Started with Realtime Database
...
1.  Select a starting mode for your security rules:
    ...
    **Test mode**
    ...
    :::note
      If you create a database in Test mode and make no changes to the
...
1.  Choose a region for the database. Depending on your choice of region,
    ...
    [select locations for your project](https://firebase.google.com/docs/projects/locations.md##rtdb-locations).
...
import SecurityPreamble from './_usecase_security_preamble.mdx';
...
To use the default Database instance, call the [`instance`](!firebase_database.FirebaseDatabase.instance)
getter on [`FirebaseDatabase`](!firebase_database.FirebaseDatabase):

```dart
FirebaseDatabase database = FirebaseDatabase.instance;
```

If you'd like to use it with a secondary Firebase App, use the [`instanceFor`](!firebase_database.FirebaseDatabase.instanceFor) method:
...
* Learn how to [structure data](structure-data.mdx) for Realtime Database.

* [Scale your data across multiple database instances.](https://firebase.google.com/docs/database/usage/sharding)

* [Read and write data.](read-and-write.mdx)

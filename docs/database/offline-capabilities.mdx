---
title: Enabling Offline Capabilities
sidebar_label: Enabling Offline Capabilities
---
...
[https://firebase.google.com/docs/database/flutter/offline-capabilities](https://firebase.google.com/docs/database/flutter/offline-capabilities)
...
If your app uses <a href="../auth/overview.mdx">Firebase Authentication</a>,
...
:::caution Transactions are not persisted across app restarts

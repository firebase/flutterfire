...
If using FlutterFire on the web, add the [`firebase-database`](!firebase_database) JavaScript SDK to your `index.html` file:
...
<html>
  ...
  <body>
    ...
    <script src="https://www.gstatic.com/firebasejs/{{ web.firebase_cdn }}/firebase-database.js"></script>
  </body>
</html>
```

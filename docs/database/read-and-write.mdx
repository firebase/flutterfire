...
[https://firebase.google.com/docs/database/flutter/read-and-write](https://firebase.google.com/docs/database/flutter/read-and-write)
...
A detailed [walkthrough involving Realtime Database and Cloud Functions](https:/firebase.google.com/docs/emulator-suite/connect_and_prototype?database=RTDB) is available. You should also have a look at the [Emulator Suite introduction](https:/firebase.google.com/docs/emulator-suite/).
...
[data fan-out](structure-data.mdx#fanout). For example, a
...
[Learn more about online and offline capabilities](offline-capabilities.mdx).

## Next steps

* [Working with lists of data](lists-of-data.mdx)
* [Learn how to structure data](structure-data.mdx)
* [Learn more about online and offline capabilities](offline-capabilities.mdx)

...
In general, it is good practice to keep this value as small as possible to reduce network overhead and improve render time. If the height (or width)
  ...
  builder: (context, snapshot, _) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final user = snapshot.documents[index] as Map<String, dynamic>;

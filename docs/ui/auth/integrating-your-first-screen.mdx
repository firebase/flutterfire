...
we are requiring that the the user should be sign-in before accessing the main application. To do this,
...
<Image
  src="ui/ui-auth-no-providers.png"
  alt="FlutterFire UI Auth - No providers"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
<Image
  src="ui/ui-auth-email-provider.png"
  alt="FlutterFire UI Auth - Email provider"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
<Image
  src="ui/ui-auth-email-google-provider.png"
  alt="FlutterFire UI Auth - Email + Google provider"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
<Image
  src="ui/ui-auth-google-email-provider.png"
  alt="FlutterFire UI Auth - Google provider first"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
<Image
  src="ui/ui-auth-signin-header.png"
  alt="FlutterFire UI Auth - Header"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
<Image
  src="ui/ui-auth-desktop-side-content.png"
  alt="FlutterFire UI Auth - Desktop side content"
  caption={false}
  style={{ maxHeight: 700 }}
/>

### Sub-title & footer content
...
<Image
  src="ui/ui-auth-signin-subtitle.png"
  alt="FlutterFire UI Auth - Subtitle + Footer"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
and handle navigation yourself. Set the `showAuthActionSwitch` property to `false` to disable this behaviour:
...
<Image
  src="ui/ui-auth-register.png"
  alt="FlutterFire UI Auth - Register"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
A screen which allows the user enter their email address to send a password reset email.
...
<Image
  src="ui/ui-auth-forgot-password.png"
  alt="FlutterFire UI Auth - Forgot password"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
<Image
  src="ui/ui-auth-phone-input-screen.png"
  alt="FlutterFire UI Auth - Phone input screen"
  caption={false}
  style={{ maxHeight: 700 }}
/>
...
<Image
  src="ui/ui-auth-profile-screen.png"
  alt="FlutterFire UI Auth - Profile"
  caption={false}
  style={{ maxHeight: 700 }}
/>

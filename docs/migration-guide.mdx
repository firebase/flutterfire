...
- **Messaging only**: If you added an `intent-filter` to your `android/app/src/main/AndroidManifest.xml` file, remove it:
```diff
- <intent-filter>
...
- </intent-filter>
```
- **Messaging only**: TODO docs on Android v2 embedding
...
- **Messaging only**: TODO what to remove from messaging

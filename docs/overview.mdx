...
:::important
The FlutterFire CLI depends on the [Firebase CLI] (https://firebase.google.com/docs/cli). If you haven't installed it yet, you can learn more in the [documentation]. 
:::

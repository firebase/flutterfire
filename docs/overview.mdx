...
> FlutterFire is currently work in progress as we work towards a stable release. Plugins & documentation may be incomplete
...
To initialize FlutterFire, call the `initializeApp` method on the `FirebaseCore` instance:

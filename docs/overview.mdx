...
:::important
The [FlutterFire CLI](./cli.mdx) depends on the [Firebase CLI] (https://firebase.google.com/docs/cli). If you haven't installed it yet, you can learn more in the [documentation](./cli.mdx). 
:::

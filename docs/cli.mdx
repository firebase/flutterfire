...
| ---------------------: | :-------------------------------------------------------------: | :-------------------------------------------------------------: | :-: | :-------------------------------------------------------------: |
|              Analytics |                                ✔                                |                              **?**                              |  ✔  |                                ✔                                |
|            Crashlytics |                                ✔                                | [**?**](./crashlytics/overview#2-optional-platform-integration) | N/A |                                ✔                                |
...
| --android-app-id  | -a    | The package name of your Android app, e.g. "com.example.app". If no package name is provided, an attempt will be made to automatically detect it from your "android" folder (if it exists). |

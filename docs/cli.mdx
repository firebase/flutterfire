...
:::note
If you initialize your application from Dart, you will likely receive warnings from the native Firebase SDKs indicating no Firebase app has been configured or

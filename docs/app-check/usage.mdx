...
You may also use the [Firebase Local Emulator Suite](https://firebase.google.com/docs/emulator-suite) to test your Cloud Function. You simply have to add another conditional check (i.e. `!process.env.FUNCTIONS_EMULATOR`) to check the veracity of the caller:

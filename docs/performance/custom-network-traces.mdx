---
title: Add custom monitoring for specific network requests
sidebar_label: Monitor specific network requests
---
...
The
[network request traces automatically collected by Performance Monitoring](https://firebase.google.com/docs/perf-mon/network-traces)
...
* [Set up alerts](https://firebase.google.com/docs/perf-mon/alerts) for network requests that are degrading

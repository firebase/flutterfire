---
title: Add custom monitoring for specific app code
sidebar_label: Monitor specific code
---
...
:::note
Starting and stopping traces too rapidly can be resource intensive, so
...
[**_default attributes_**](https://firebase.google.com/docs/perf-mon/attributes)

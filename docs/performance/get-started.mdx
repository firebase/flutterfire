---
title: Get started with Performance Monitoring for Flutter
...
:::note
When you add Performance Monitoring to your app, the Remote Config SDK is
...
[Remote Config documentation](/docs/remote-config/overview) to learn more
...
instrument [**custom code traces**](custom-code-traces).
...
Visit [Add monitoring for specific code](custom-code-traces)
...
* Learn more about data automatically collected by Performance Monitoring:
  ...
  * Data related to your app's lifecycle, like
    [app start time](https://firebase.google.com/docs/perf-mon/app-start-foreground-background-traces)
  * Data for [HTTP/S network requests](https://firebase.google.com/docs/perf-mon/network-traces) issued
    by your app
...
* Add monitoring for specific tasks or workflows in your app by
  [instrumenting custom code traces](custom-code-traces).

...
If using FlutterFire on the web, add the [`firebase-performance`](!firebase_performance) JavaScript SDK to your `index.html` file:
...
<html>
  ...
  <body>
    ...
    <script src="https://www.gstatic.com/firebasejs/{{ web.firebase_cdn }}/firebase-performance.js"></script>
  </body>
</html>
```

...
> Crashlytics is enabled by default, to disable it in debug mode or for opt-in purposes see [toggle Crashlytics collection.](usage#toggle-crashlytics-collection)

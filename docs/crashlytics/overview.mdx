...
If you are migrating from a previous version of Crashlytics that used Fabric, please follow this [upgrade guide](https://firebase.google.com/docs/crashlytics/upgrade-sdk?platform=android).
...
2. Apply the following plugins to the `/android/app/build.gradle` file.
...
4. You can also provide your app's built `Info.plist` location to the build phase's Input Files field:

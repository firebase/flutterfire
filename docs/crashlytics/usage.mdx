...
Enable Forebase Crashytlics in the Firebase console.
...
//Elsehwere in your code
FirebaseCrashlytics.instance.crash();
```

This will restart the application. If using an emulator, please re-run...

```dart
  flutter run
```

`or restart the app manually through the emulator.`

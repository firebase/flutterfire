...
For example to ensure enabled when your app is in debug mode you can do the following:
...
if (kDebugMode) {
  // Force enable crashlytics collection enabled if we're testing it in debug.

...
Flutter project. The current package name can be found in the `manifest` tag within the projects
`/android/app/src/main/AndroidManifest.xml` file.

> When creating a new Android app "debug signing certificate SHA-1" is optional, however is required for Dynamic Links

...
### 2. Install `cloud_firestore` plugin
...
Next, install the `build_runner`, `cloud_firestore_odm_generator` & `json_serializable` packages as dev dependencies:

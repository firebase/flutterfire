...
:::caution
Dart-only initialization **does not work** with `firebase_in_app_messaging`,
please follow the Platfrom Setup section from the [manual installation guide](../manual-installation.mdx)
for the supported platfroms.
:::

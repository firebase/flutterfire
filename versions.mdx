---
{
    "1.5.0": {
        ...
        "firebase_in_app_messaging": "0.7.5+2",
    ...
    "1.4.0": {
        ...
        "firebase_in_app_messaging": "0.7.5+2",
        "firebase_app_check": "0.2.2+2",
        "firebase_ml_model_downloader": "0.2.5+2",
        "native_sdk": {
            "android": "32.8.0",
            "ios": "10.24.0",
            "web": "10.10.0",
...
## [Flutter BoM 1.5.0 (2024-04-18)](https://github.com/firebase/flutterfire/blob/master/CHANGELOG.md#2024-04-18)

<!-- When ready can be included
Install this version using FlutterFire CLI

```bash
flutterfire install 1.5.0
```
-->
...
| Web SDK | 10.10.0 | [Release Notes](https://firebase.google.com/support/release-notes/web) |
| Windows SDK | 11.6.0 | [Release Notes](https://firebase.google.com/support/release-notes/windows) |
...
| [firebase_ml_model_downloader](https://pub.dev/packages/firebase_ml_model_downloader/versions/) |  |



## [Flutter BoM 1.4.0 (2024-04-18)](https://github.com/firebase/flutterfire/blob/master/CHANGELOG.md#2024-04-18)

Install this version using FlutterFire CLI

```bash
flutterfire install 1.4.0
```
